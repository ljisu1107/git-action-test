import CJS_COMPAT_NODE_URL_8sy1434zve from 'node:url';
import CJS_COMPAT_NODE_PATH_8sy1434zve from 'node:path';
import CJS_COMPAT_NODE_MODULE_8sy1434zve from "node:module";

var __filename = CJS_COMPAT_NODE_URL_8sy1434zve.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_8sy1434zve.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_8sy1434zve.createRequire(import.meta.url);
  ...
  "../../../node_modules/jiti/dist/jiti.cjs"(exports, module) {
    (() => {
      var e = { "./node_modules/.pnpm/mlly@1.8.2/node_modules/mlly/dist lazy recursive"(e2) {
        ...
        "use strict";
        var n = Object.defineProperty, r = (e3, t3) => n(e3, "name", { value: t3, configurable: !0 }), a = i2("node:path"), c = i2("node:fs"), l = i2("node:module"), y = i2("./node_modules/.pnpm/resolve-pkg-maps@1.0.0/node_modules/resolve-pkg-maps/dist/index.cjs"), E = i2("fs"), w = i2("os"), C = i2("path");
        function h(e3) {
        ...
        let S = r((e3) => {
          let t3 = c[e3];
          return (i3, ...n2) => {
            let a2 = `${e3}:${n2.join(":")}`, l2 = i3?.get(a2);
            return l2 === void 0 && (l2 = Reflect.apply(t3, c, n2), i3?.set(a2, l2)), l2;
          };
        }, "cacheFs"), I = S("existsSync"), N = S("readFileSync"), O = S("statSync"), j = r((e3, t3, i3) => {
          for (; ; ) {
            let n2 = a.posix.join(e3, t3);
        ...
        function Ne(e3, t3 = !1) {
          let i3 = e3.length, n2 = 0, a2 = "", c2 = 0, l2 = 16, y2 = 0, E2 = 0, w2 = 0, C2 = 0, S2 = 0;
          function _(t4, i4) {
            let a3 = 0, c3 = 0;
            for (; a3 < t4; ) {
          ...
          function p() {
            ...
            let i4 = n2;
            if (n2 < e3.length && (e3.charCodeAt(n2) === 69 || e3.charCodeAt(n2) === 101)) if (n2++, (n2 < e3.length && e3.charCodeAt(n2) === 43 || e3.charCodeAt(n2) === 45) && n2++, n2 < e3.length && R(e3.charCodeAt(n2))) {
              for (n2++; n2 < e3.length && R(e3.charCodeAt(n2)); ) n2++;
              i4 = n2;
            } else S2 = 3;
...
`;
          ...
          function A() {
            ...
            if (M(t4)) return n2++, a2 += String.fromCharCode(t4), t4 === 13 && e3.charCodeAt(n2) === 10 && (n2++, a2 += `
`), y2++, w2 = n2, l2 = 14;
            switch (t4) {
              case 123:
                return n2++, l2 = 1;
        ...
        function We(e3, t3, i3 = K.DEFAULT) {
          let n2 = Ne(e3, !1), a2 = [], c2 = 0;
          function o(e4) {
            return e4 ? () => c2 === 0 && e4(n2.getTokenOffset(), n2.getTokenLength(), n2.getTokenStartLine(), n2.getTokenStartCharacter()) : () => !0;
          }
          function f(e4) {
            return e4 ? (t4) => c2 === 0 && e4(t4, n2.getTokenOffset(), n2.getTokenLength(), n2.getTokenStartLine(), n2.getTokenStartCharacter()) : () => !0;
          }
          function u(e4) {
            return e4 ? (t4) => c2 === 0 && e4(t4, n2.getTokenOffset(), n2.getTokenLength(), n2.getTokenStartLine(), n2.getTokenStartCharacter(), () => a2.slice()) : () => !0;
          }
          function g(e4) {
            return e4 ? () => {
              c2 > 0 ? c2++ : e4(n2.getTokenOffset(), n2.getTokenLength(), n2.getTokenStartLine(), n2.getTokenStartCharacter(), () => a2.slice()) === !1 && (c2 = 1);
            } : () => !0;
          }
          function m(e4) {
            return e4 ? () => {
          ...
          let l2 = g(t3.onObjectBegin), y2 = u(t3.onObjectProperty), E2 = m(t3.onObjectEnd), w2 = g(t3.onArrayBegin), C2 = m(t3.onArrayEnd), S2 = u(t3.onLiteralValue), I2 = f(t3.onSeparator), N2 = o(t3.onComment), O2 = f(t3.onError), j2 = i3 && i3.disallowComments, F2 = i3 && i3.allowTrailingComma;
          function T() {
            for (; ; ) {
              let e4 = n2.scan();
          ...
          function k(e4, t4 = [], i4 = []) {
            if (O2(e4), t4.length + i4.length > 0) {
              ...
              for (; e5 !== 17; ) {
                ...
                if (i4.indexOf(e5) !== -1) break;
                e5 = T();
              }
            }
          }
          function P(e4) {
            let t4 = n2.getTokenValue();
            return e4 ? S2(t4) : (y2(t4), a2.push(t4)), T(), !0;
          }
          function J() {
            switch (n2.getToken()) {
              case 11:
                let e4 = n2.getTokenValue(), t4 = Number(e4);
          ...
          function V() {
            return n2.getToken() !== 10 ? (k(3, [], [2, 5]), !1) : (P(!1), n2.getToken() === 6 ? (I2(":"), T(), U() || k(4, [], [2, 5])) : k(5, [], [2, 5]), a2.pop(), !0);
          }
          function z() {
            l2(), T();
            let e4 = !1;
            for (; n2.getToken() !== 2 && n2.getToken() !== 17; ) {
              if (n2.getToken() === 5) {
                if (e4 || k(4, [], []), I2(","), T(), n2.getToken() === 2 && F2) break;
              } else e4 && k(6, [], []);
              V() || k(4, [], [2, 5]), e4 = !0;
            }
            return E2(), n2.getToken() !== 2 ? k(7, [2], []) : T(), !0;
          }
          function G() {
            w2(), T();
            let e4 = !0, t4 = !1;
            for (; n2.getToken() !== 4 && n2.getToken() !== 17; ) {
              if (n2.getToken() === 5) {
                if (t4 || k(4, [], []), I2(","), T(), n2.getToken() === 4 && F2) break;
              } else t4 && k(6, [], []);
              e4 ? (a2.push(0), e4 = !1) : a2[a2.length - 1]++, U() || k(4, [], [4, 5]), t4 = !0;
            }
            return C2(), e4 || a2.pop(), n2.getToken() !== 4 ? k(8, [4], []) : T(), !0;
          }
          function U() {
            switch (n2.getToken()) {
              case 3:
          ...
          return r(T, "scanNext"), r(k, "handleError"), r(P, "parseString"), r(J, "parseLiteral"), r(V, "parseProperty"), r(z, "parseObject"), r(G, "parseArray"), r(U, "parseValue"), T(), n2.getToken() === 17 ? !!i3.allowEmptyContent || (k(4, [], []), !1) : U() ? (n2.getToken() !== 17 && k(9, [], []), !0) : (k(4, [], []), !1);
        }
...
` + "	".repeat(t3)), (function(e3) {
          e3.DEFAULT = { allowTrailingComma: !1 };
        ...
        let X = r((e3, t3) => Q(N(t3, e3, "utf8")), "readJsonc"), te = /* @__PURE__ */ Symbol("implicitBaseUrl"), ie = "${configDir}", se = r(() => {
          let { findPnpApi: e3 } = l;
          return e3 && e3(process.cwd());
        }, "getPnpApi"), re = r((e3, t3, i3, n2) => {
          let c2 = `resolveFromPackageJsonPath:${e3}:${t3}:${i3}`;
          if (n2 != null && n2.has(c2)) return n2.get(c2);
          let l2 = X(e3, n2);
          if (!l2) return;
          let E2 = t3 || "tsconfig.json";
          if (!i3 && l2.exports) try {
            let [e4] = y.resolveExports(l2.exports, t3, ["require", "types"]);
            E2 = e4;
          } catch {
            return !1;
          }
          else !t3 && l2.tsconfig && (E2 = l2.tsconfig);
          return E2 = a.join(e3, "..", E2), n2?.set(c2, E2), E2;
          ...
          let [c2, ...l2] = e3.split("/"), y2 = c2[0] === "@" ? `${c2}/${l2.shift()}` : c2, E2 = l2.join("/"), w2 = se();
          if (w2) {
            let { resolveRequest: n3 } = w2;
            try {
              if (y2 === e3) {
                let e4 = n3(a.join(y2, ne), t3);
                if (e4) {
                  let t4 = re(e4, E2, !1, i3);
          ...
          let C2 = j(a.resolve(t3), a.join("node_modules", y2), i3);
          if (!C2 || !O(i3, C2).isDirectory()) return;
          let S2 = a.join(C2, ne);
          if (I(i3, S2)) {
            let e4 = re(S2, E2, !1, i3);
            if (e4 === !1) return;
            if (e4 && I(i3, e4) && O(i3, e4).isFile()) return e4;
          }
          let N2 = a.join(C2, E2), F2 = N2.endsWith(".json");
          if (!F2) {
            let e4 = `${N2}.json`;
            if (I(i3, e4)) return e4;
          }
          ...
          let n2 = a.relative(e3, t3);
          return n2 ? h(`${n2}/${i3.startsWith("./") ? i3.slice(2) : i3}`) : i3;
          ...
          if (typeof n2 != "object") throw new SyntaxError(`Failed to parse tsconfig at: ${e3}`);
          let c2 = a.dirname(e3);
          if (n2.compilerOptions) {
            let { compilerOptions: e4 } = n2;
            e4.paths && !e4.baseUrl && (e4[te] = c2);
          }
          if (n2.extends) {
            let e4 = Array.isArray(n2.extends) ? n2.extends : [n2.extends];
            delete n2.extends;
            for (let a2 of e4.reverse()) {
              let e5 = ue(a2, c2, new Set(i3), t3), l2 = { ...e5, ...n2, compilerOptions: { ...e5.compilerOptions, ...n2.compilerOptions } };
              e5.watchOptions && (l2.watchOptions = { ...e5.watchOptions, ...n2.watchOptions }), n2 = l2;
            }
          }
          if (n2.compilerOptions) {
            let { compilerOptions: e4 } = n2, t4 = ["baseUrl", "rootDir"];
            for (let i4 of t4) {
              let t5 = e4[i4];
              if (t5 && !t5.startsWith(ie)) {
                let n3 = a.resolve(c2, t5), l2 = ce(c2, n3);
                e4[i4] = l2;
              }
            }
            for (let t5 of de) {
          ...
          if (e3.strict) {
            let t3 = ["noImplicitAny", "noImplicitThis", "strictNullChecks", "strictFunctionTypes", "strictBindCallApply", "strictPropertyInitialization", "strictBuiltinIteratorReturn", "alwaysStrict", "useUnknownInCatchVariables"];
            for (let i3 of t3) e3[i3] === void 0 && (e3[i3] = !0);
          }
          if (e3.composite && (e3.declaration != null || (e3.declaration = !0), e3.incremental != null || (e3.incremental = !0)), e3.target) {
            let t3 = e3.target.toLowerCase();
            t3 === "es2015" && (t3 = "es6"), e3.target = t3, t3 === "esnext" && (e3.module != null || (e3.module = "es6"), e3.useDefineForClassFields != null || (e3.useDefineForClassFields = !0)), (t3 === "es6" || t3 === "es2016" || t3 === "es2017" || t3 === "es2018" || t3 === "es2019" || t3 === "es2020" || t3 === "es2021" || t3 === "es2022" || t3 === "es2023" || t3 === "es2024") && (e3.module != null || (e3.module = "es6")), (t3 === "es2022" || t3 === "es2023" || t3 === "es2024") && (e3.useDefineForClassFields != null || (e3.useDefineForClassFields = !0));
          }
          if (e3.module) {
            let t3 = e3.module.toLowerCase();
            if (t3 === "es2015" && (t3 = "es6"), e3.module = t3, (t3 === "es6" || t3 === "es2020" || t3 === "es2022" || t3 === "esnext" || t3 === "none" || t3 === "system" || t3 === "umd" || t3 === "amd") && (e3.moduleResolution != null || (e3.moduleResolution = "classic")), t3 === "system" && (e3.allowSyntheticDefaultImports != null || (e3.allowSyntheticDefaultImports = !0)), (t3 === "node16" || t3 === "node18" || t3 === "node20" || t3 === "nodenext" || t3 === "preserve") && (e3.esModuleInterop != null || (e3.esModuleInterop = !0), e3.allowSyntheticDefaultImports != null || (e3.allowSyntheticDefaultImports = !0)), (t3 === "node16" || t3 === "node18" || t3 === "node20" || t3 === "nodenext") && (e3.moduleDetection != null || (e3.moduleDetection = "force")), t3 === "node16" && (e3.target != null || (e3.target = "es2022"), e3.moduleResolution != null || (e3.moduleResolution = "node16")), t3 === "node18" && (e3.target != null || (e3.target = "es2022"), e3.moduleResolution != null || (e3.moduleResolution = "node16")), t3 === "node20" && (e3.target != null || (e3.target = "es2023"), e3.moduleResolution != null || (e3.moduleResolution = "node16"), e3.resolveJsonModule != null || (e3.resolveJsonModule = !0)), t3 === "nodenext" && (e3.target != null || (e3.target = "esnext"), e3.moduleResolution != null || (e3.moduleResolution = "nodenext"), e3.resolveJsonModule != null || (e3.resolveJsonModule = !0)), t3 === "node16" || t3 === "node18" || t3 === "node20" || t3 === "nodenext") {
              let t4 = e3.target;
              (t4 === "es3" || t4 === "es2022" || t4 === "es2023" || t4 === "es2024" || t4 === "esnext") && (e3.useDefineForClassFields != null || (e3.useDefineForClassFields = !0));
            }
          ...
          if (e3.moduleResolution) {
            ...
            t3 === "node" && (t3 = "node10"), e3.moduleResolution = t3, (t3 === "node16" || t3 === "nodenext" || t3 === "bundler") && (e3.resolvePackageJsonExports != null || (e3.resolvePackageJsonExports = !0), e3.resolvePackageJsonImports != null || (e3.resolvePackageJsonImports = !0)), t3 === "bundler" && (e3.allowSyntheticDefaultImports != null || (e3.allowSyntheticDefaultImports = !0), e3.resolveJsonModule != null || (e3.resolveJsonModule = !0));
          }
          e3.jsx && (e3.jsx = e3.jsx.toLowerCase()), e3.moduleDetection && (e3.moduleDetection = e3.moduleDetection.toLowerCase()), e3.importsNotUsedAsValues && (e3.importsNotUsedAsValues = e3.importsNotUsedAsValues.toLowerCase()), e3.newLine && (e3.newLine = e3.newLine.toLowerCase()), e3.esModuleInterop && (e3.allowSyntheticDefaultImports != null || (e3.allowSyntheticDefaultImports = !0)), e3.verbatimModuleSyntax && (e3.isolatedModules != null || (e3.isolatedModules = !0), e3.preserveConstEnums != null || (e3.preserveConstEnums = !0)), e3.isolatedModules && (e3.preserveConstEnums != null || (e3.preserveConstEnums = !0)), e3.rewriteRelativeImportExtensions && (e3.allowImportingTsExtensions != null || (e3.allowImportingTsExtensions = !0)), e3.lib && (e3.lib = e3.lib.map((e4) => e4.toLowerCase())), e3.checkJs && (e3.allowJs != null || (e3.allowJs = !0));
        }, "normalizeCompilerOptions"), ve = r((e3, t3 = /* @__PURE__ */ new Map()) => {
          let i3 = a.resolve(e3), n2 = fe(i3, t3), c2 = a.dirname(i3), { compilerOptions: l2 } = n2;
          if (l2) {
            for (let e5 of ge) {
              let t4 = l2[e5];
              if (t4) {
            ...
            for (let e5 of ["rootDirs", "typeRoots"]) {
              let t4 = l2[e5];
              t4 && (l2[e5] = t4.map((e6) => {
                let t5 = me(e6, c2);
            ...
            let { paths: e4 } = l2;
            if (e4) for (let t4 of Object.keys(e4)) e4[t4] = e4[t4].map((e5) => {
              var t5;
        ...
        var ye = Object.defineProperty, _e = r((e3, t3) => ye(e3, "name", { value: t3, configurable: !0 }), "s");
        let Ee = _e((e3) => {
          let t3 = "";
          for (let i3 = 0; i3 < e3.length; i3 += 1) {
            let n2 = e3[i3], a2 = n2.toUpperCase();
            t3 += n2 === a2 ? n2.toLowerCase() : a2;
          }
          return t3;
        }, "invertCase"), be = /* @__PURE__ */ new Map(), ke = _e((e3, t3) => {
          let i3 = C.join(e3, `.is-fs-case-sensitive-test-${process.pid}`);
          try {
          ...
          try {
            ...
            if (t3 === void 0) return ke(w.tmpdir(), i3);
            throw e4;
          }
        }, "checkDirectoryCaseWithFallback"), Ce = _e((e3, t3 = E, i3 = !0) => {
          let n2 = e3 ?? process.cwd();
          ...
          Me && (t3 = h(t3));
          let n2 = a.dirname(t3), { files: c2, include: l2, exclude: y2, compilerOptions: E2 } = e3, w2 = r((e4) => a.isAbsolute(e4) ? e4 : Se(n2, e4), "resolvePattern"), C2 = c2?.map(w2), S2 = Te(E2), I2 = i3 ? "" : "i", N2 = (y2 || Re(E2)).map((e4) => {
            let t4 = w2(e4), i4 = Ae(t4).replaceAll(String.raw`\*\*/`, "(.+/)?").replaceAll(String.raw`\*`, `${Ve}*`).replaceAll(String.raw`\?`, Ve);
            return new RegExp(`^${i4}($|/)`, I2);
          }), O2 = c2 || l2 ? l2 : [De], j2 = O2 ? O2.map((e4) => {
            let t4 = w2(e4);
            Oe.test(t4) && (t4 = Se(t4, De));
            let i4 = Ae(t4).replaceAll(String.raw`/\*\*`, `(/${Le}${Ue}${Ve}*)*?`).replaceAll(/(\/)?\\\*/g, (e5, t5) => {
              let i5 = `(${Ue}|(\\.(?!min\\.js$))?)*`;
          ...
          return (t4) => {
            ...
            return Me && (t4 = h(t4)), C2 != null && C2.includes(t4) || S2.some((e4) => t4.endsWith(e4)) && !N2.some((e4) => e4.test(t4)) && j2 && j2.some((e4) => e4.test(t4)) ? e3 : void 0;
          };
        }, "createFilesMatcher"), Fe = r((e3, t3, i3) => {
          let n2 = a.resolve(e3), c2 = h(e3);
          for (; ; ) {
            let e4 = j(c2, t3, i3);
            if (!e4) return;
            let l2 = a.resolve(e4), y2 = ve(l2, i3), E2 = { path: h(l2), config: y2 };
            if (je(E2)(n2)) return E2;
            let w2 = a.dirname(e4), C2 = a.dirname(w2);
            if (C2 === w2) return;
            c2 = C2;
          }
        }, "findConfigApplicable"), Be = r((e3 = process.cwd(), t3 = "tsconfig.json", i3 = /* @__PURE__ */ new Map(), n2 = !1) => {
          var a2;
          return n2 ? (a2 = Fe(e3, t3, i3)) == null ? void 0 : a2.path : j(h(e3), t3, i3);
        }, "findTsconfig"), $e = r((e3 = process.cwd(), t3 = "tsconfig.json", i3 = /* @__PURE__ */ new Map(), n2 = !1) => {
          var a2;
          if (!n2) {
            let n3 = Be(e3, t3, i3);
            return n3 ? { path: n3, config: ve(n3, i3) } : null;
          }
          ...
          let { compilerOptions: t3 } = e3.config;
          if (!t3) return null;
          let { baseUrl: i3, paths: n2 } = t3;
          if (!i3 && !n2) return null;
          let c2 = te in t3 && t3[te], l2 = a.resolve(a.dirname(e3.path), i3 || c2 || "."), y2 = n2 ? ze(n2, i3, l2) : [];
          return (e4) => {
            if (F.test(e4)) return [];
            let t4 = [];
            for (let i4 of y2) {
            ...
            let n3, c3 = -1;
            for (let i4 of t4) He(i4.pattern, e4) && i4.pattern.prefix.length > c3 && (c3 = i4.pattern.prefix.length, n3 = i4);
            if (!n3) return i3 ? [h(a.join(l2, e4))] : [];
            let E2 = e4.slice(n3.pattern.prefix.length, e4.length - n3.pattern.suffix.length);
        ...
        let d = (e3) => e3 !== null && typeof e3 == "object", s = (e3, t3) => Object.assign(new Error(`[${e3}]: ${t3}`), { code: e3 }), i2 = "ERR_INVALID_PACKAGE_CONFIG", n = "ERR_INVALID_PACKAGE_TARGET", a = /^\d+$/, c = /^(\.{1,2}|node_modules)$/i, l = /\/|\\/;
        var y, E = ((y = E || {}).Export = "exports", y.Import = "imports", y);
        let f = (e3, t3, y2, E2, w2) => {
          if (t3 == null) return [];
          if (typeof t3 == "string") {
            let [i3, ...a2] = t3.split(l);
          ...
          if (d(t3)) {
            for (let n2 of Object.keys(t3)) {
              if (a.test(n2)) throw s(i2, "Cannot contain numeric property keys");
              if (n2 === "default" || E2.includes(n2)) return f(e3, t3[n2], y2, E2, w2);
            }
            return [];
          }
          throw s(n, `Invalid "${e3}" target "${t3}"`);
        }, w = "*", v = (e3, t3) => {
          let i3 = e3.indexOf(w), n2 = t3.indexOf(w);
          return i3 === n2 ? t3.length > e3.length : n2 > i3;
        };
        function A(e3, t3) {
          if (!t3.includes(w) && e3.hasOwnProperty(t3)) return [t3];
          let i3, n2;
          for (let a2 of Object.keys(e3)) if (a2.includes(w)) {
            let [e4, c2, l2] = a2.split(w);
            if (l2 === void 0 && t3.startsWith(e4) && t3.endsWith(c2)) {
              let l3 = t3.slice(e4.length, -c2.length || void 0);
        ...
        t2.resolveExports = (e3, t3, a2) => {
          ...
          t3 = t3 === "" ? "." : `./${t3}`, (typeof e3 == "string" || Array.isArray(e3) || d(e3) && ((e4) => Object.keys(e4).reduce((e5, t4) => {
            let n2 = t4 === "" || t4[0] !== ".";
            if (e5 === void 0 || e5 === n2) return n2;
            throw s(i2, '"exports" cannot contain some keys starting with "." and some not');
          }, void 0))(e3)) && (e3 = { ".": e3 });
          let [c2, l2] = A(e3, t3), y2 = f(E.Export, e3[c2], t3, a2, l2);
          if (y2.length === 0) throw s("ERR_PACKAGE_PATH_NOT_EXPORTED", t3 === "." ? 'No "exports" main defined' : `Package subpath '${t3}' is not defined by "exports"`);
          for (let e4 of y2) if (!e4.startsWith("./") && !C.test(e4)) throw s(n, `Invalid "exports" target "${e4}" defined in the package config`);
          return y2;
        }, t2.resolveImports = (e3, t3, i3) => {
          if (!e3) throw new Error('"imports" is required');
          let [n2, a2] = A(e3, t3), c2 = f(E.Import, e3[n2], t3, i3, a2);
          if (c2.length === 0) throw s("ERR_PACKAGE_IMPORT_NOT_DEFINED", `Package import specifier "${t3}" is not defined in package`);
          return c2;
        };
      } }, t = {};
      ...
      (() => {
        ...
        function isInAstralSet(e3, t3) {
          for (var i2 = 65536, n2 = 0; n2 < t3.length; n2 += 2) {
            if ((i2 += t3[n2]) > e3) return !1;
            if ((i2 += t3[n2 + 1]) >= e3) return !0;
          }
          return !1;
        }
        function isIdentifierStart(e3, t3) {
          return e3 < 65 ? e3 === 36 : e3 < 91 || (e3 < 97 ? e3 === 95 : e3 < 123 || (e3 <= 65535 ? e3 >= 170 && w.test(String.fromCharCode(e3)) : t3 !== !1 && isInAstralSet(e3, n)));
        }
        function isIdentifierChar(e3, i2) {
          return e3 < 48 ? e3 === 36 : e3 < 58 || !(e3 < 65) && (e3 < 91 || (e3 < 97 ? e3 === 95 : e3 < 123 || (e3 <= 65535 ? e3 >= 170 && C.test(String.fromCharCode(e3)) : i2 !== !1 && (isInAstralSet(e3, n) || isInAstralSet(e3, t2)))));
        }
        ...
        function nextLineBreak(e3, t3, i2) {
          ...
          for (var n2 = t3; n2 < i2; n2++) {
            ...
            if (isNewLine(a2)) return n2 < i2 - 1 && a2 === 13 && e3.charCodeAt(n2 + 1) === 10 ? n2 + 2 : n2 + 1;
          }
          return -1;
        }
        ...
        var X = { ecmaVersion: null, sourceType: "script", onInsertedSemicolon: null, onTrailingComma: null, allowReserved: null, allowReturnOutsideFunction: !1, allowImportExportEverywhere: !1, allowAwaitOutsideFunction: null, allowSuperOutsideMethod: null, allowHashBang: !1, checkPrivateFields: !0, locations: !1, onToken: null, onComment: null, ranges: !1, program: null, sourceFile: null, directSourceFile: null, preserveParens: !1 }, te = !1;
        function getOptions(e3) {
          var t3 = {};
          for (var i2 in X) t3[i2] = e3 && H(e3, i2) ? e3[i2] : X[i2];
          if (t3.ecmaVersion === "latest" ? t3.ecmaVersion = 1e8 : t3.ecmaVersion == null ? (!te && typeof console == "object" && console.warn && (te = !0, console.warn(`Since Acorn 8.0.0, options.ecmaVersion is required.
Defaulting to 2020, but this will stop working in the future.`)), t3.ecmaVersion = 11) : t3.ecmaVersion >= 2015 && (t3.ecmaVersion -= 2009), t3.allowReserved == null && (t3.allowReserved = t3.ecmaVersion < 5), e3 && e3.allowHashBang != null || (t3.allowHashBang = t3.ecmaVersion >= 14), Y(t3.onToken)) {
          ...
          })(t3, t3.onComment)), t3.sourceType === "commonjs" && t3.allowAwaitOutsideFunction) throw new Error("Cannot use allowAwaitOutsideFunction with sourceType: commonjs");
          return t3;
        }
        var ie = 256, se = 259;
        ...
        var acorn_Parser = function(e3, t3, i2) {
          ...
          var n2 = "";
          e3.allowReserved !== !0 && (n2 = c[e3.ecmaVersion >= 6 ? 6 : e3.ecmaVersion === 5 ? 5 : 3], e3.sourceType === "module" && (n2 += " await")), this.reservedWords = wordsRegexp(n2);
          var a2 = (n2 ? n2 + " " : "") + c.strict;
          this.reservedWordsStrict = wordsRegexp(a2), this.reservedWordsStrictBind = wordsRegexp(a2 + " " + c.strictBind), this.input = String(t3), this.containsEsc = !1, i2 ? (this.pos = i2, this.lineStart = this.input.lastIndexOf(`
`, i2 - 1) + 1, this.curLine = this.input.slice(0, this.lineStart).split(j).length) : (this.pos = this.lineStart = 0, this.curLine = 1), this.type = O.eof, this.value = null, this.start = this.end = this.pos, this.startLoc = this.endLoc = this.curPosition(), this.lastTokEndLoc = this.lastTokStartLoc = null, this.lastTokStart = this.lastTokEnd = this.pos, this.context = this.initialContext(), this.exprAllowed = !0, this.inModule = e3.sourceType === "module", this.strict = this.inModule || this.strictDirective(this.pos), this.potentialArrowAt = -1, this.potentialArrowInForAwait = !1, this.yieldPos = this.awaitPos = this.awaitIdentPos = 0, this.labels = [], this.undefinedExports = /* @__PURE__ */ Object.create(null), this.pos === 0 && e3.allowHashBang && this.input.slice(0, 2) === "#!" && this.skipLineComment(2), this.scopeStack = [], this.enterScope(this.options.sourceType === "commonjs" ? 2 : 1), this.regexpState = null, this.privateNameStack = [];
        }, re = { inFunction: { configurable: !0 }, inGenerator: { configurable: !0 }, inAsync: { configurable: !0 }, canAwait: { configurable: !0 }, allowReturn: { configurable: !0 }, allowSuper: { configurable: !0 }, allowDirectSuper: { configurable: !0 }, treatFunctionsAsVar: { configurable: !0 }, allowNewDotTarget: { configurable: !0 }, allowUsing: { configurable: !0 }, inClassStaticBlock: { configurable: !0 } };
        ...
        oe.isLet = function(e3) {
          ...
          if (j.test(this.input.slice(this.pos, n2))) return !1;
          if (e3) {
            var a2, c2 = n2 + 5;
            if (this.input.slice(n2, c2) !== "using" || c2 === this.input.length || isIdentifierChar(a2 = this.fullCharCodeAt(c2)) || a2 === 92) return !1;
            $.lastIndex = c2;
            var l2 = $.exec(this.input);
            if (n2 = c2 + l2[0].length, l2 && j.test(this.input.slice(c2, n2))) return !1;
          }
          var y2 = this.fullCharCodeAt(n2);
          if (!isIdentifierStart(y2) && y2 !== 92) return !1;
          var w2 = n2;
          do
            n2 += y2 <= 65535 ? 1 : 2;
          ...
          switch (this.isLet(e3) && (a2 = O._var, n2 = "let"), a2) {
            ...
            case O._function:
              return e3 && (this.strict || e3 !== "if" && e3 !== "label") && this.options.ecmaVersion >= 6 && this.unexpected(), this.parseFunctionStatement(c2, !1, !e3);
            case O._class:
              return e3 && this.unexpected(), this.parseClass(c2, !0);
            case O._if:
            ...
            case O._import:
              if (this.options.ecmaVersion > 10 && a2 === O._import) {
                ...
                if (E2 === 40 || E2 === 46) return this.parseExpressionStatement(c2, this.parseExpression());
              }
            ...
            default:
              if (this.isAsyncFunction()) return e3 && this.unexpected(), this.next(), this.parseFunctionStatement(c2, !0, !e3);
              var w2 = this.isAwaitUsing(!1) ? "await using" : this.isUsing(!1) ? "using" : null;
              if (w2) return this.allowUsing || this.raise(this.start, "Using declaration cannot appear in the top level when source type is `script` or in the bare case statement"), w2 === "await using" && (this.canAwait || this.raise(this.start, "Await using cannot appear outside of async function"), this.next()), this.next(), this.parseVar(c2, !1, w2), this.semicolon(), this.finishNode(c2, "VariableDeclaration");
              var C2 = this.value, S2 = this.parseExpression();
              return a2 === O.name && S2.type === "Identifier" && this.eat(O.colon) ? this.parseLabeledStatement(c2, C2, S2, e3) : this.parseExpressionStatement(c2, S2);
          }
          ...
          for (var n2 = 0; n2 < this.labels.length; ++n2) {
            ...
            if ((e3.label == null || a2.name === e3.label.name) && (a2.kind != null && (i2 || a2.kind === "loop") || e3.label && i2))
              break;
          }
          ...
          if (this.type === O._var || this.type === O._const || i2) {
            ...
            return this.next(), this.parseVar(n2, !0, a2), this.finishNode(n2, "VariableDeclaration"), this.parseForAfterInit(e3, n2, t3);
          }
          var c2 = this.isContextual("let"), l2 = !1, y2 = this.isUsing(!0) ? "using" : this.isAwaitUsing(!0) ? "await using" : null;
          if (y2) {
            var E2 = this.startNode();
            return this.next(), y2 === "await using" && (this.canAwait || this.raise(this.start, "Await using cannot appear outside of async function"), this.next()), this.parseVar(E2, !0, y2), this.finishNode(E2, "VariableDeclaration"), this.parseForAfterInit(e3, E2, t3);
          }
          var w2 = this.containsEsc, C2 = new acorn_DestructuringErrors(), S2 = this.start, I2 = t3 > -1 ? this.parseExprSubscripts(C2, "await") : this.parseExpression(!0, C2);
          return this.type === O._in || (l2 = this.options.ecmaVersion >= 6 && this.isContextual("of")) ? (t3 > -1 ? (this.type === O._in && this.unexpected(t3), e3.await = !0) : l2 && this.options.ecmaVersion >= 8 && (I2.start !== S2 || w2 || I2.type !== "Identifier" || I2.name !== "async" ? this.options.ecmaVersion >= 9 && (e3.await = !1) : this.unexpected()), c2 && l2 && this.raise(I2.start, "The left-hand side of a for-of loop may not start with 'let'."), this.toAssignable(I2, !1, C2), this.checkLValPattern(I2), this.parseForIn(e3, I2)) : (this.checkExpressionErrors(C2, !0), t3 > -1 && this.unexpected(t3), this.parseFor(e3, I2));
          ...
          return this.next(), this.parseFunction(e3, pe | (i2 ? 0 : ue), !1, t3);
          ...
          for (var i2 = !1; this.type !== O.braceR; ) if (this.type === O._case || this.type === O._default) {
            var n2 = this.type === O._case;
            t3 && this.finishNode(t3, "SwitchCase"), e3.cases.push(t3 = this.startNode()), t3.consequent = [], this.next(), n2 ? t3.test = this.parseExpression() : (i2 && this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"), i2 = !0, t3.test = null), this.expect(O.colon);
        ...
        oe.parseCatchClauseParam = function() {
          ...
          if (this.next(), e3.block = this.parseBlock(), e3.handler = null, this.type === O._catch) {
            ...
            this.next(), this.eat(O.parenL) ? t3.param = this.parseCatchClauseParam() : (this.options.ecmaVersion < 10 && this.unexpected(), t3.param = null, this.enterScope(0)), t3.body = this.parseBlock(!1), this.exitScope(), e3.handler = this.finishNode(t3, "CatchClause");
          }
          ...
          for (e3 === void 0 && (e3 = !0), t3 === void 0 && (t3 = this.startNode()), t3.body = [], this.expect(O.braceL), e3 && this.enterScope(0); this.type !== O.braceR; ) {
        ...
        function isPrivateNameConflicted(e3, t3) {
          ...
          return t3.type !== "MethodDefinition" || t3.kind !== "get" && t3.kind !== "set" || (a2 = (t3.static ? "s" : "i") + t3.kind), n2 === "iget" && a2 === "iset" || n2 === "iset" && a2 === "iget" || n2 === "sget" && a2 === "sset" || n2 === "sset" && a2 === "sget" ? (e3[i2] = "true", !1) : !!n2 || (e3[i2] = a2, !1);
        }
        ...
        oe.parseFunction = function(e3, t3, i2, n2, a2) {
          ...
          return this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(functionFlags(e3.async, e3.generator)), t3 & pe || (e3.id = this.type === O.name ? this.parseIdent() : null), this.parseFunctionParams(e3), this.parseFunctionBody(e3, i2, !1, a2), this.yieldPos = c2, this.awaitPos = l2, this.awaitIdentPos = y2, this.finishNode(e3, t3 & pe ? "FunctionDeclaration" : "FunctionExpression");
        }, oe.parseFunctionParams = function(e3) {
          this.expect(O.parenL), e3.params = this.parseBindingList(O.parenR, !1, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams();
        }, oe.parseClass = function(e3, t3) {
          this.next();
          var i2 = this.strict;
          this.strict = !0, this.parseClassId(e3, t3), this.parseClassSuper(e3);
          var n2 = this.enterClassBody(), a2 = this.startNode(), c2 = !1;
          for (a2.body = [], this.expect(O.braceL); this.type !== O.braceR; ) {
            var l2 = this.parseClassElement(e3.superClass !== null);
            l2 && (a2.body.push(l2), l2.type === "MethodDefinition" && l2.kind === "constructor" ? (c2 && this.raiseRecoverable(l2.start, "Duplicate constructor in the same class"), c2 = !0) : l2.key && l2.key.type === "PrivateIdentifier" && isPrivateNameConflicted(n2, l2) && this.raiseRecoverable(l2.key.start, "Identifier '#" + l2.key.name + "' has already been declared"));
          }
          ...
          var t3 = this.options.ecmaVersion, i2 = this.startNode(), n2 = "", a2 = !1, c2 = !1, l2 = "method", y2 = !1;
          if (this.eatContextual("static")) {
            if (t3 >= 13 && this.eat(O.braceL)) return this.parseClassStaticBlock(i2), i2;
            this.isClassElementNameStart() || this.type === O.star ? y2 = !0 : n2 = "static";
          }
          if (i2.static = y2, !n2 && t3 >= 8 && this.eatContextual("async") && (!this.isClassElementNameStart() && this.type !== O.star || this.canInsertSemicolon() ? n2 = "async" : c2 = !0), !n2 && (t3 >= 9 || !c2) && this.eat(O.star) && (a2 = !0), !n2 && !c2 && !a2) {
            var E2 = this.value;
            (this.eatContextual("get") || this.eatContextual("set")) && (this.isClassElementNameStart() ? l2 = E2 : n2 = E2);
          }
          if (n2 ? (i2.computed = !1, i2.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), i2.key.name = n2, this.finishNode(i2.key, "Identifier")) : this.parseClassElementName(i2), t3 < 13 || this.type === O.parenL || l2 !== "method" || a2 || c2) {
            var w2 = !i2.static && checkKeyName(i2, "constructor"), C2 = w2 && e3;
            w2 && l2 !== "method" && this.raise(i2.key.start, "Constructor can't have get/set modifier"), i2.kind = w2 ? "constructor" : l2, this.parseClassMethod(i2, a2, c2, C2);
          ...
          this.type === O.privateId ? (this.value === "constructor" && this.raise(this.start, "Classes can't have an element named '#constructor'"), e3.computed = !1, e3.key = this.parsePrivateIdent()) : this.parsePropertyName(e3);
          ...
          this.type === O.name ? (e3.id = this.parseIdent(), t3 && this.checkLValSimple(e3.id, 2, !1)) : (t3 === !0 && this.unexpected(), e3.id = null);
        }, oe.parseClassSuper = function(e3) {
          e3.superClass = this.eat(O._extends) ? this.parseExprSubscripts(null, !1) : null;
          ...
          if (this.options.checkPrivateFields) for (var n2 = this.privateNameStack.length, a2 = n2 === 0 ? null : this.privateNameStack[n2 - 1], c2 = 0; c2 < i2.length; ++c2) {
            var l2 = i2[c2];
          ...
          if (this.type === O._function || (e3 = this.isAsyncFunction())) {
            var t3 = this.startNode();
            return this.next(), e3 && this.next(), this.parseFunction(t3, 4 | pe, !1, e3);
          }
          ...
          e3 && (typeof t3 != "string" && (t3 = t3.type === "Identifier" ? t3.name : t3.value), H(e3, t3) && this.raiseRecoverable(i2, "Duplicate export '" + t3 + "'"), e3[t3] = !0);
        }, oe.checkPatternExport = function(e3, t3) {
          var i2 = t3.type;
          if (i2 === "Identifier") this.checkExport(e3, t3, t3.start);
          else if (i2 === "ObjectPattern") for (var n2 = 0, a2 = t3.properties; n2 < a2.length; n2 += 1) {
            var c2 = a2[n2];
            this.checkPatternExport(e3, c2);
          }
          else if (i2 === "ArrayPattern") for (var l2 = 0, y2 = t3.elements; l2 < y2.length; l2 += 1) {
            var E2 = y2[l2];
          ...
          for (var t3 = {}, i2 = !0; !this.eat(O.braceR); ) {
            if (i2) i2 = !1;
            else if (this.expect(O.comma), this.afterTrailingComma(O.braceR)) break;
            var n2 = this.parseImportAttribute(), a2 = n2.key.type === "Identifier" ? n2.key.name : n2.key.value;
            H(t3, a2) && this.raiseRecoverable(n2.key.start, "Duplicate attribute key '" + a2 + "'"), t3[a2] = !0, e3.push(n2);
          }
          return e3;
        ...
        de.toAssignable = function(e3, t3, i2) {
          ...
          if (this.options.ecmaVersion >= 6) switch (this.type) {
            case O.bracketL:
              var e3 = this.startNode();
              return this.next(), e3.elements = this.parseBindingList(O.bracketR, !0, !0), this.finishNode(e3, "ArrayPattern");
            case O.braceL:
              return this.parseObj(!0);
          }
          return this.parseIdent();
        }, de.parseBindingList = function(e3, t3, i2, n2) {
          for (var a2 = [], c2 = !0; !this.eat(e3); ) if (c2 ? c2 = !1 : this.expect(O.comma), t3 && this.type === O.comma) a2.push(null);
          else {
          ...
          switch (e3.type) {
            case "Identifier":
              this.strict && this.reservedWordsStrictBind.test(e3.name) && this.raiseRecoverable(e3.start, (n2 ? "Binding " : "Assigning to ") + e3.name + " in strict mode"), n2 && (t3 === 2 && e3.name === "let" && this.raiseRecoverable(e3.start, "let is disallowed as a lexically bound name"), i2 && (H(i2, e3.name) && this.raiseRecoverable(e3.start, "Argument name clash"), i2[e3.name] = !0), t3 !== 5 && this.declareName(e3.name, t3, e3.start));
              break;
            case "ChainExpression":
              this.raiseRecoverable(e3.start, "Optional chaining cannot appear in left-hand side");
              break;
        ...
        }, fe = { b_stat: new acorn_TokContext("{", !1), b_expr: new acorn_TokContext("{", !0), b_tmpl: new acorn_TokContext("${", !1), p_stat: new acorn_TokContext("(", !1), p_expr: new acorn_TokContext("(", !0), q_tmpl: new acorn_TokContext("`", !0, !0, function(e3) {
          return e3.tryReadTemplateToken();
        }), f_stat: new acorn_TokContext("function", !1), f_expr: new acorn_TokContext("function", !0), f_expr_gen: new acorn_TokContext("function", !0, !1, null, !0), f_gen: new acorn_TokContext("function", !1, !1, null, !0) }, me = acorn_Parser.prototype;
        me.initialContext = function() {
          ...
          var t3, i2 = this.type;
          i2.keyword && e3 === O.dot ? this.exprAllowed = !1 : (t3 = i2.updateContext) ? t3.call(this, e3) : this.exprAllowed = i2.beforeExpr;
          ...
          this.context.push(this.braceIsBlock(e3) ? fe.b_stat : fe.b_expr), this.exprAllowed = !0;
          ...
          this.context.push(t3 ? fe.p_stat : fe.p_expr), this.exprAllowed = !0;
        }, O.incDec.updateContext = function() {
        }, O._function.updateContext = O._class.updateContext = function(e3) {
          !e3.beforeExpr || e3 === O._else || e3 === O.semi && this.curContext() !== fe.p_stat || e3 === O._return && j.test(this.input.slice(this.lastTokEnd, this.start)) || (e3 === O.colon || e3 === O.braceL) && this.curContext() === fe.b_stat ? this.context.push(fe.f_stat) : this.context.push(fe.f_expr), this.exprAllowed = !1;
          ...
          var t3 = !1;
          this.options.ecmaVersion >= 6 && e3 !== O.dot && (this.value === "of" && !this.exprAllowed || this.value === "yield" && this.inGeneratorContext()) && (t3 = !0), this.exprAllowed = t3;
        };
        ...
        ge.checkPropClash = function(e3, t3, i2) {
          if (!(this.options.ecmaVersion >= 9 && e3.type === "SpreadElement" || this.options.ecmaVersion >= 6 && (e3.computed || e3.method || e3.shorthand))) {
            ...
            var c2 = e3.kind;
            if (this.options.ecmaVersion >= 6) n2 === "__proto__" && c2 === "init" && (t3.proto && (i2 ? i2.doubleProto < 0 && (i2.doubleProto = a2.start) : this.raiseRecoverable(a2.start, "Redefinition of __proto__ property")), t3.proto = !0);
            else {
              var l2 = t3[n2 = "$" + n2];
              l2 ? (c2 === "init" ? this.strict && l2.init || l2.get || l2.set : l2.init || l2[c2]) && this.raiseRecoverable(a2.start, "Redefinition of property") : l2 = t3[n2] = { init: !1, get: !1, set: !1 }, l2[c2] = !0;
            }
          }
          ...
          var n2 = !1, a2 = -1, c2 = -1, l2 = -1;
          t3 ? (a2 = t3.parenthesizedAssign, c2 = t3.trailingComma, l2 = t3.doubleProto, t3.parenthesizedAssign = t3.trailingComma = -1) : (t3 = new acorn_DestructuringErrors(), n2 = !0);
          ...
          return n2 && this.checkExpressionErrors(t3, !0), a2 > -1 && (t3.parenthesizedAssign = a2), c2 > -1 && (t3.trailingComma = c2), w2;
          ...
          var i2 = this.start, n2 = this.startLoc, a2 = this.parseMaybeUnary(t3, !1, !1, e3);
          ...
          if (c2 != null && (!a2 || this.type !== O._in) && c2 > n2) {
            ...
            var E2 = this.value;
            this.next();
            var w2 = this.start, C2 = this.startLoc, S2 = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, a2), w2, C2, c2, a2), I2 = this.buildBinary(t3, i2, e3, S2, E2, l2 || y2);
          ...
          if (this.isContextual("await") && this.canAwait) a2 = this.parseAwait(n2), t3 = !0;
          else if (this.type.prefix) {
            var y2 = this.startNode(), E2 = this.type === O.incDec;
            y2.operator = this.value, y2.prefix = !0, this.next(), y2.argument = this.parseMaybeUnary(null, !0, E2, n2), this.checkExpressionErrors(e3, !0), E2 ? this.checkLValSimple(y2.argument) : this.strict && y2.operator === "delete" && isLocalVariableAccess(y2.argument) ? this.raiseRecoverable(y2.start, "Deleting local variable in strict mode") : y2.operator === "delete" && isPrivateFieldAccess(y2.argument) ? this.raiseRecoverable(y2.start, "Private fields can not be deleted") : t3 = !0, a2 = this.finishNode(y2, E2 ? "UpdateExpression" : "UnaryExpression");
            ...
            for (; this.type.postfix && !this.canInsertSemicolon(); ) {
              ...
              w2.operator = this.value, w2.prefix = !1, w2.argument = a2, this.checkLValSimple(a2), this.next(), a2 = this.finishNode(w2, "UpdateExpression");
            }
          } else (n2 || this.privateNameStack.length === 0) && this.options.checkPrivateFields && this.unexpected(), a2 = this.parsePrivateIdent(), this.type !== O._in && this.unexpected();
          return i2 || !this.eat(O.starstar) ? a2 : t3 ? void this.unexpected(this.lastTokStart) : this.buildBinary(c2, l2, a2, this.parseMaybeUnary(null, !1, !1, n2), "**", !1);
        }, ge.parseExprSubscripts = function(e3, t3) {
          var i2 = this.start, n2 = this.startLoc, a2 = this.parseExprAtom(e3, t3);
          if (a2.type === "ArrowFunctionExpression" && this.input.slice(this.lastTokStart, this.lastTokEnd) !== ")") return a2;
          var c2 = this.parseSubscripts(a2, i2, n2, !1, t3);
          ...
          for (var c2 = this.options.ecmaVersion >= 8 && e3.type === "Identifier" && e3.name === "async" && this.lastTokEnd === e3.end && !this.canInsertSemicolon() && e3.end - e3.start === 5 && this.potentialArrowAt === e3.start, l2 = !1; ; ) {
            var y2 = this.parseSubscript(e3, t3, i2, n2, c2, l2, a2);
            if (y2.optional && (l2 = !0), y2 === e3 || y2.type === "ArrowFunctionExpression") {
              if (l2) {
          ...
          return this.parseArrowExpression(this.startNodeAt(e3, t3), i2, !0, n2);
          ...
          if (w2 || E2 && this.type !== O.parenL && this.type !== O.backQuote || this.eat(O.dot)) {
            ...
            C2.object = e3, w2 ? (C2.property = this.parseExpression(), this.expect(O.bracketR)) : this.type === O.privateId && e3.type !== "Super" ? C2.property = this.parsePrivateIdent() : C2.property = this.parseIdent(this.options.allowReserved !== "never"), C2.computed = !!w2, y2 && (C2.optional = E2), e3 = this.finishNode(C2, "MemberExpression");
            ...
            var F2 = this.parseExprList(O.parenR, this.options.ecmaVersion >= 8, !1, S2);
            if (a2 && !E2 && this.shouldParseAsyncArrow()) return this.checkPatternErrors(S2, !1), this.checkYieldAwaitInDefaultParams(), this.awaitIdentPos > 0 && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = I2, this.awaitPos = N2, this.awaitIdentPos = j2, this.parseSubscriptAsyncArrow(t3, i2, F2, l2);
            this.checkExpressionErrors(S2, !0), this.yieldPos = I2 || this.yieldPos, this.awaitPos = N2 || this.awaitPos, this.awaitIdentPos = j2 || this.awaitIdentPos;
            ...
            $2.tag = e3, $2.quasi = this.parseTemplate({ isTagged: !0 }), e3 = this.finishNode($2, "TaggedTemplateExpression");
          }
          return e3;
          ...
          switch (this.type) {
            ...
            case O.name:
              var c2 = this.start, l2 = this.startLoc, y2 = this.containsEsc, E2 = this.parseIdent(!1);
              if (this.options.ecmaVersion >= 8 && !y2 && E2.name === "async" && !this.canInsertSemicolon() && this.eat(O._function)) return this.overrideContext(fe.f_expr), this.parseFunction(this.startNodeAt(c2, l2), 0, !1, !0, t3);
              if (a2 && !this.canInsertSemicolon()) {
                if (this.eat(O.arrow)) return this.parseArrowExpression(this.startNodeAt(c2, l2), [E2], !1, t3);
                if (this.options.ecmaVersion >= 8 && E2.name === "async" && this.type === O.name && !y2 && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc)) return E2 = this.parseIdent(!1), !this.canInsertSemicolon() && this.eat(O.arrow) || this.unexpected(), this.parseArrowExpression(this.startNodeAt(c2, l2), [E2], !0, t3);
              }
              return E2;
            case O.regexp:
              var w2 = this.value;
            ...
            case O.bracketL:
              return n2 = this.startNode(), this.next(), n2.elements = this.parseExprList(O.bracketR, !0, !0, e3), this.finishNode(n2, "ArrayExpression");
            case O.braceL:
              return this.overrideContext(fe.b_expr), this.parseObj(!1, e3);
            case O._function:
          ...
          if (this.options.ecmaVersion >= 6) {
            this.next();
            var l2, y2 = this.start, E2 = this.startLoc, w2 = [], C2 = !0, S2 = !1, I2 = new acorn_DestructuringErrors(), N2 = this.yieldPos, j2 = this.awaitPos;
            for (this.yieldPos = 0, this.awaitPos = 0; this.type !== O.parenR; ) {
              if (C2 ? C2 = !1 : this.expect(O.comma), c2 && this.afterTrailingComma(O.parenR, !0)) {
                S2 = !0;
                break;
              }
              if (this.type === O.ellipsis) {
              ...
              w2.push(this.parseMaybeAssign(!1, I2, this.parseParenItem));
            }
            var F2 = this.lastTokEnd, B2 = this.lastTokEndLoc;
            if (this.expect(O.parenR), e3 && this.shouldParseArrow(w2) && this.eat(O.arrow)) return this.checkPatternErrors(I2, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = N2, this.awaitPos = j2, this.parseParenArrowList(n2, a2, w2, t3);
            w2.length && !S2 || this.unexpected(this.lastTokStart), l2 && this.unexpected(l2), this.checkExpressionErrors(I2, !0), this.yieldPos = N2 || this.yieldPos, this.awaitPos = j2 || this.awaitPos, w2.length > 1 ? ((i2 = this.startNodeAt(y2, E2)).expressions = w2, this.finishNodeAt(i2, "SequenceExpression", F2, B2)) : i2 = w2[0];
          ...
          return this.parseArrowExpression(this.startNodeAt(e3, t3), i2, !1, n2);
        };
        var xe = [];
        ge.parseNew = function() {
          ...
          return e3.callee = this.parseSubscripts(this.parseExprAtom(null, !1, !0), n2, a2, !0, !1), this.eat(O.parenL) ? e3.arguments = this.parseExprList(O.parenR, this.options.ecmaVersion >= 8, !1) : e3.arguments = xe, this.finishNode(e3, "NewExpression");
...
`), cooked: this.value }, this.next(), i2.tail = this.type === O.backQuote, this.finishNode(i2, "TemplateElement");
          ...
          if (this.options.ecmaVersion >= 9 && this.eat(O.ellipsis)) return e3 ? (l2.argument = this.parseIdent(!1), this.type === O.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element"), this.finishNode(l2, "RestElement")) : (l2.argument = this.parseMaybeAssign(!1, t3), this.type === O.comma && t3 && t3.trailingComma < 0 && (t3.trailingComma = this.start), this.finishNode(l2, "SpreadElement"));
          this.options.ecmaVersion >= 6 && (l2.method = !1, l2.shorthand = !1, (e3 || t3) && (a2 = this.start, c2 = this.startLoc), e3 || (i2 = this.eat(O.star)));
          var y2 = this.containsEsc;
          return this.parsePropertyName(l2), !e3 && !y2 && this.options.ecmaVersion >= 8 && !i2 && this.isAsyncProp(l2) ? (n2 = !0, i2 = this.options.ecmaVersion >= 9 && this.eat(O.star), this.parsePropertyName(l2)) : n2 = !1, this.parsePropertyValue(l2, e3, i2, n2, a2, c2, t3, y2), this.finishNode(l2, "Property");
          ...
          if (a2) e3.body = this.parseMaybeAssign(n2), e3.expression = !0, this.checkParams(e3, !1);
            ...
            var E2 = this.labels;
            this.labels = [], l2 && (this.strict = !0), this.checkParams(e3, !c2 && !l2 && !t3 && !i2 && this.isSimpleParamList(e3.params)), this.strict && e3.id && this.checkLValSimple(e3.id, 5), e3.body = this.parseBlock(!1, void 0, l2 && !c2), e3.expression = !1, this.adaptDirectivePrologue(e3.body.body), this.labels = E2;
          }
          this.exitScope();
          ...
          for (var a2 = [], c2 = !0; !this.eat(e3); ) {
            if (c2) c2 = !1;
            else if (this.expect(O.comma), t3 && this.afterTrailingComma(e3)) break;
            var l2 = void 0;
            i2 && this.type === O.comma ? l2 = null : this.type === O.ellipsis ? (l2 = this.parseSpread(n2), n2 && this.type === O.comma && n2.trailingComma < 0 && (n2.trailingComma = this.start)) : l2 = this.parseMaybeAssign(!1, n2), a2.push(l2);
          }
          return a2;
          ...
          var t3 = this.startNode();
          return this.next(), this.type === O.semi || this.canInsertSemicolon() || this.type !== O.star && !this.type.startsExpr ? (t3.delegate = !1, t3.argument = null) : (t3.delegate = this.eat(O.star), t3.argument = this.parseMaybeAssign(e3)), this.finishNode(t3, "YieldExpression");
        ...
        acorn_RegExpValidationState.prototype.reset = function(e3, t3, i2) {
          ...
          this.start = 0 | e3, this.source = t3 + "", this.flags = i2, n2 && this.parser.options.ecmaVersion >= 15 ? (this.switchU = !0, this.switchV = !0, this.switchN = !0) : (this.switchU = a2 && this.parser.options.ecmaVersion >= 6, this.switchV = !1, this.switchN = a2 && this.parser.options.ecmaVersion >= 9);
          ...
          for (var i2 = this.pos, n2 = 0, a2 = e3; n2 < a2.length; n2 += 1) {
            ...
            if (l2 === -1 || l2 !== c2) return !1;
            i2 = this.nextIndex(i2, t3);
          }
          return this.pos = i2, !0;
        }, Me.validateRegExpFlags = function(e3) {
          for (var t3 = e3.validFlags, i2 = e3.flags, n2 = !1, a2 = !1, c2 = 0; c2 < i2.length; c2++) {
            var l2 = i2.charAt(c2);
            t3.indexOf(l2) === -1 && this.raise(e3.start, "Invalid regular expression flag"), i2.indexOf(l2, c2 + 1) > -1 && this.raise(e3.start, "Duplicate regular expression flag"), l2 === "u" && (n2 = !0), l2 === "v" && (a2 = !0);
          }
          ...
          if (e3.eat(123)) {
            var n2 = 0, a2 = -1;
            if (this.regexp_eatDecimalDigits(e3) && (n2 = e3.lastIntValue, e3.eat(44) && this.regexp_eatDecimalDigits(e3) && (a2 = e3.lastIntValue), e3.eat(125))) return a2 !== -1 && a2 < n2 && !t3 && e3.raise("numbers out of order in {} quantifier"), !0;
          ...
          })(n2) ? (e3.lastIntValue = n2, !0) : (e3.pos = t3, !1);
            ...
            if (this.regexp_eatFixedHexDigits(e3, 4)) {
              ...
              if (a2 && c2 >= 55296 && c2 <= 56319) {
                ...
                if (e3.eat(92) && e3.eat(117) && this.regexp_eatFixedHexDigits(e3, 4)) {
                  ...
                  if (y2 >= 56320 && y2 <= 57343) return e3.lastIntValue = 1024 * (c2 - 55296) + (y2 - 56320) + 65536, !0;
                }
                e3.pos = l2, e3.lastIntValue = c2;
              }
              return !0;
            }
            if (a2 && e3.eat(123) && this.regexp_eatHexDigits(e3) && e3.eat(125) && (i2 = e3.lastIntValue) >= 0 && i2 <= 1114111) return !0;
        ...
        Me.regexp_eatCharacterClassEscape = function(e3) {
          ...
          if (e3.switchU && this.options.ecmaVersion >= 9 && ((i2 = t3 === 80) || t3 === 112)) {
            var n2;
            if (e3.lastIntValue = -1, e3.advance(), e3.eat(123) && (n2 = this.regexp_eatUnicodePropertyValueExpression(e3)) && e3.eat(125)) return i2 && n2 === 2 && e3.raise("Invalid property name"), n2;
          ...
          var n2 = e3.current();
          return n2 !== 93 && (e3.lastIntValue = n2, e3.advance(), !0);
          ...
          if (!this.regexp_eatClassSetRange(e3)) if (t3 = this.regexp_eatClassSetOperand(e3)) {
            t3 === 2 && (i2 = 2);
            for (var n2 = e3.pos; e3.eatChars([38, 38]); ) e3.current() !== 38 && (t3 = this.regexp_eatClassSetOperand(e3)) ? t3 !== 2 && (i2 = 1) : e3.raise("Invalid character in character class");
          ...
          if (this.regexp_eatClassSetCharacter(e3)) {
            ...
            if (e3.eat(45) && this.regexp_eatClassSetCharacter(e3)) {
              ...
              return i2 !== -1 && n2 !== -1 && i2 > n2 && e3.raise("Range out of order in character class"), !0;
            }
            e3.pos = t3;
          }
          return !1;
          ...
          if (e3.eat(91)) {
            ...
            if (e3.eat(93)) return i2 && n2 === 2 && e3.raise("Negated character class may contain strings"), n2;
            e3.pos = t3;
          }
          if (e3.eat(92)) {
          ...
          for (var n2 = 0; n2 < t3; ++n2) {
            var a2 = e3.current();
            if (!isHexDigit(a2)) return e3.pos = i2, !1;
        ...
        je.next = function(e3) {
        ...
        }, typeof Symbol < "u" && (je[Symbol.iterator] = function() {
          var e3 = this;
          ...
          if (i2 === -1 && this.raise(this.pos - 2, "Unterminated comment"), this.pos = i2 + 2, this.options.locations) for (var n2 = void 0, a2 = t3; (n2 = nextLineBreak(this.input, a2, this.pos)) > -1; ) ++this.curLine, a2 = this.lineStart = n2;
          ...
          return t3 === e3 ? this.options.ecmaVersion >= 12 && this.input.charCodeAt(this.pos + 2) === 61 ? this.finishOp(O.assign, 3) : this.finishOp(e3 === 124 ? O.logicalOR : O.logicalAND, 2) : t3 === 61 ? this.finishOp(O.assign, 2) : this.finishOp(e3 === 124 ? O.bitwiseOR : O.bitwiseAND, 1);
          ...
          if (e3 >= 11) {
            ...
            if (t3 === 63)
              return e3 >= 12 && this.input.charCodeAt(this.pos + 2) === 61 ? this.finishOp(O.assign, 3) : this.finishOp(O.coalesce, 2);
          }
          return this.finishOp(O.question, 1);
        }, je.readToken_numberSign = function() {
          var e3 = 35;
          if (this.options.ecmaVersion >= 13 && (++this.pos, isIdentifierStart(e3 = this.fullCharCodeAtPos(), !0) || e3 === 92)) return this.finishToken(O.privateId, this.readWord1());
          ...
          for (var e3, t3, i2 = this.pos; ; ) {
            ...
            if (j.test(n2) && this.raise(i2, "Unterminated regular expression"), e3) e3 = !1;
            else {
              if (n2 === "[") t3 = !0;
              else if (n2 === "]" && t3) t3 = !1;
              else if (n2 === "/" && !t3) break;
          ...
          for (var n2 = this.options.ecmaVersion >= 12 && t3 === void 0, a2 = i2 && this.input.charCodeAt(this.pos) === 48, c2 = this.pos, l2 = 0, y2 = 0, E2 = 0, w2 = t3 ?? 1 / 0; E2 < w2; ++E2, ++this.pos) {
            var C2 = this.input.charCodeAt(this.pos), S2 = void 0;
            if (n2 && C2 === 95) a2 && this.raiseRecoverable(this.pos, "Numeric separator is not allowed in legacy octal numeric literals"), y2 === 95 && this.raiseRecoverable(this.pos, "Numeric separator must be exactly one underscore"), E2 === 0 && this.raiseRecoverable(this.pos, "Numeric separator is not allowed at the first of digits"), y2 = C2;
            else {
          ...
          i2 && /[89]/.test(this.input.slice(t3, this.pos)) && (i2 = !1), n2 !== 46 || i2 || (++this.pos, this.readInt(10), n2 = this.input.charCodeAt(this.pos)), n2 !== 69 && n2 !== 101 || i2 || ((n2 = this.input.charCodeAt(++this.pos)) !== 43 && n2 !== 45 || ++this.pos, this.readInt(10) === null && this.raise(t3, "Invalid number")), isIdentifierStart(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number");
        ...
        je.tryReadTemplateToken = function() {
          ...
          for (var e3 = "", t3 = this.pos; ; ) {
            ...
            if (i2 === 96 || i2 === 36 && this.input.charCodeAt(this.pos + 1) === 123) return this.pos !== this.start || this.type !== O.template && this.type !== O.invalidTemplate ? (e3 += this.input.slice(t3, this.pos), this.finishToken(O.template, e3)) : i2 === 36 ? (this.pos += 2, this.finishToken(O.dollarBraceL)) : (++this.pos, this.finishToken(O.backQuote));
...
`;
          ...
          this.containsEsc = !1;
          for (var e3 = "", t3 = !0, i2 = this.pos, n2 = this.options.ecmaVersion >= 6; this.pos < this.input.length; ) {
        ...
        function withTrailingSlash(e3 = "", t3) {
          ...
          let i2 = e3, n2 = "", a2 = e3.indexOf("#");
          if (a2 !== -1 && (i2 = e3.slice(0, a2), n2 = e3.slice(a2), !i2)) return n2;
          let [c2, ...l2] = i2.split("?");
        ...
        function pathe_M_eThtNZ_normalizeWindowsPath(e3 = "") {
          return e3 && e3.replace(/\\/g, "/").replace(Ke, (e4) => e4.toUpperCase());
        }
        let He = /^[/\\]{2}/, ze = /^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[A-Za-z]:[/\\]/, Je = /^[A-Za-z]:$/, Ye = /.(\.[^./]+|\.)$/, pathe_M_eThtNZ_normalize = function(e3) {
          if (e3.length === 0) return ".";
          let t3 = (e3 = pathe_M_eThtNZ_normalizeWindowsPath(e3)).match(He), i2 = isAbsolute(e3), n2 = e3[e3.length - 1] === "/";
          return (e3 = normalizeString(e3, !i2)).length === 0 ? i2 ? "/" : n2 ? "./" : "." : (n2 && (e3 += "/"), Je.test(e3) && (e3 += "/"), t3 ? i2 ? `//${e3}` : `//./${e3}` : i2 && !isAbsolute(e3) ? `/${e3}` : e3);
        }, pathe_M_eThtNZ_join = function(...e3) {
          let t3 = "";
          for (let i2 of e3) if (i2) if (t3.length > 0) {
            let e4 = t3[t3.length - 1] === "/", n2 = i2[0] === "/";
        ...
        let pathe_M_eThtNZ_resolve = function(...e3) {
          ...
          for (let n2 = (e3 = e3.map((e4) => pathe_M_eThtNZ_normalizeWindowsPath(e4))).length - 1; n2 >= -1 && !i2; n2--) {
            let a2 = n2 >= 0 ? e3[n2] : pathe_M_eThtNZ_cwd();
            a2 && a2.length !== 0 && (t3 = `${a2}/${t3}`, i2 = isAbsolute(a2));
          }
        ...
        let isAbsolute = function(e3) {
          ...
          return t3.length === 1 && Je.test(t3[0]) && (t3[0] += "/"), t3.join("/") || (isAbsolute(e3) ? "/" : ".");
        }, basename = function(e3, t3) {
          let i2 = pathe_M_eThtNZ_normalizeWindowsPath(e3).split("/"), n2 = "";
        ...
        let tt = __require("node:v8"), it = __require("node:util"), st = new Set(Be.builtinModules);
        function normalizeSlash(e3) {
          return e3.replace(/\\/g, "/");
        }
        let rt = {}.hasOwnProperty, nt = /^([A-Z][a-z\d]*)+$/, at = /* @__PURE__ */ new Set(["string", "function", "number", "object", "Function", "Object", "boolean", "bigint", "symbol"]), ot = {};
        function formatList(e3, t3 = "and") {
          return e3.length < 3 ? e3.join(` ${t3} `) : `${e3.slice(0, -1).join(", ")}, ${t3} ${e3[e3.length - 1]}`;
        }
        let ct = /* @__PURE__ */ new Map(), ht;
        function createError(e3, t3, i2) {
          return ct.set(e3, t3), /* @__PURE__ */ (function(e4, t4) {
            return NodeError;
            function NodeError(...i3) {
              let n2 = Error.stackTraceLimit;
              isErrorStackTraceLimitWritable() && (Error.stackTraceLimit = 0);
              let a2 = new e4();
              isErrorStackTraceLimitWritable() && (Error.stackTraceLimit = n2);
              let c2 = (function(e5, t5, i4) {
                let n3 = ct.get(e5);
                if (Ze.ok(n3 !== void 0, "expected `message` to be found"), typeof n3 == "function") return Ze.ok(n3.length <= t5.length, `Code: ${e5}; The provided arguments length (${t5.length}) does not match the required ones (${n3.length}).`), Reflect.apply(n3, i4, t5);
                let a3 = /%[dfijoOs]/g, c3 = 0;
                for (; a3.exec(n3) !== null; ) c3++;
              ...
              return Object.defineProperties(a2, { message: { value: c2, enumerable: !1, writable: !0, configurable: !0 }, toString: { value() {
                return `${this.name} [${t4}]: ${this.message}`;
              }, enumerable: !1, writable: !0, configurable: !0 } }), lt(a2), a2.code = t4, a2;
            }
          })(i2, e3);
        }
        function isErrorStackTraceLimitWritable() {
          ...
          return e3 === void 0 ? Object.isExtensible(Error) : rt.call(e3, "writable") && e3.writable !== void 0 ? e3.writable : e3.set !== void 0;
        }
        ot.ERR_INVALID_ARG_TYPE = createError("ERR_INVALID_ARG_TYPE", (e3, t3, i2) => {
          ...
          n2 += "must be ";
          let a2 = [], c2 = [], l2 = [];
          for (let e4 of t3) Ze.ok(typeof e4 == "string", "All expected entries have to be of type string"), at.has(e4) ? a2.push(e4.toLowerCase()) : nt.exec(e4) === null ? (Ze.ok(e4 !== "object", 'The value "object" should be written as "Object"'), l2.push(e4)) : c2.push(e4);
          if (c2.length > 0) {
            let e4 = a2.indexOf("object");
        ...
        }), pt = {}.hasOwnProperty, { ERR_INVALID_PACKAGE_CONFIG: ut } = ot, dt = /* @__PURE__ */ new Map();
        function read(e3, { base: t3, specifier: i2 }) {
          ...
          let c2 = { exists: !1, pjsonPath: e3, main: void 0, name: void 0, type: "none", exports: void 0, imports: void 0 };
          if (a2 !== void 0) {
            let n3;
            try {
              n3 = JSON.parse(a2);
            } catch (n4) {
              let a3 = n4, c3 = new ut(e3, (t3 ? `"${i2}" from ` : "") + (0, Qe.fileURLToPath)(t3 || i2), a3.message);
              throw c3.cause = a3, c3;
            }
            c2.exists = !0, pt.call(n3, "name") && typeof n3.name == "string" && (c2.name = n3.name), pt.call(n3, "main") && typeof n3.main == "string" && (c2.main = n3.main), pt.call(n3, "exports") && (c2.exports = n3.exports), pt.call(n3, "imports") && (c2.imports = n3.imports), !pt.call(n3, "type") || n3.type !== "commonjs" && n3.type !== "module" || (c2.type = n3.type);
          }
        ...
        function getPackageScopeConfig(e3) {
          ...
          for (; !t3.pathname.endsWith("node_modules/package.json"); ) {
            let i2 = read((0, Qe.fileURLToPath)(t3), { specifier: e3 });
            if (i2.exists) return i2;
            let n2 = t3;
            if (t3 = new URL("../package.json", t3), t3.pathname === n2.pathname) break;
          }
          return { pjsonPath: (0, Qe.fileURLToPath)(t3), exists: !1, type: "none" };
        }
        function getPackageType(e3) {
          return getPackageScopeConfig(e3).type;
        }
        let { ERR_UNKNOWN_FILE_EXTENSION: ft } = ot, mt = {}.hasOwnProperty, gt = { __proto__: null, ".cjs": "commonjs", ".js": "module", ".json": "json", ".mjs": "module" }, xt = { __proto__: null, "data:": function(e3) {
        ...
        function emitLegacyIndexDeprecation(e3, t3, i2, n2) {
          if (Xe.noDeprecation || (function(e4, t4) {
            let i3 = e4.protocol;
            return mt.call(xt, i3) && xt[i3](e4, t4, !0) || null;
          })(e3, { parentURL: i2.href }) !== "module") return;
          let c2 = (0, Qe.fileURLToPath)(e3.href), l2 = (0, Qe.fileURLToPath)(new URL(".", t3)), y2 = (0, Qe.fileURLToPath)(i2);
...
Default "index" lookups for the main are deprecated for ES modules.`, "DeprecationWarning", "DEP0151");
        ...
        function fileExists(e3) {
          let t3 = (0, $e.statSync)(e3, { throwIfNoEntry: !1 }), i2 = t3 ? t3.isFile() : void 0;
          return i2 != null && i2;
        }
        function legacyMainResolve(e3, t3, i2) {
          ...
          if (t3.main !== void 0) {
            ...
            let a3 = [`./${t3.main}.js`, `./${t3.main}.json`, `./${t3.main}.node`, `./${t3.main}/index.js`, `./${t3.main}/index.json`, `./${t3.main}/index.node`], c3 = -1;
            for (; ++c3 < a3.length && (n2 = new URL(a3[c3], e3), !fileExists(n2)); ) n2 = void 0;
            if (n2) return emitLegacyIndexDeprecation(n2, e3, i2, t3.main), n2;
          }
          let a2 = ["./index.js", "./index.json", "./index.node"], c2 = -1;
        ...
        function resolvePackageTargetString(e3, t3, i2, n2, a2, c2, l2, y2, E2) {
          ...
          if (At.exec(e3.slice(2)) !== null) {
            if (Pt.exec(e3.slice(2)) !== null) throw invalidPackageTarget(i2, e3, n2, l2, a2);
            if (!y2) {
              let y3 = c2 ? i2.replace("*", () => t3) : i2 + t3;
              emitInvalidSegmentDeprecation(c2 ? _t.call(Nt, e3, () => t3) : e3, y3, i2, n2, l2, a2, !0);
            }
          }
          let w2 = new URL(e3, n2), C2 = w2.pathname, S2 = new URL(".", n2).pathname;
          if (!C2.startsWith(S2)) throw invalidPackageTarget(i2, e3, n2, l2, a2);
          if (t3 === "") return w2;
          if (At.exec(t3) !== null) {
            let E3 = c2 ? i2.replace("*", () => t3) : i2 + t3;
            Pt.exec(t3) === null ? y2 || emitInvalidSegmentDeprecation(c2 ? _t.call(Nt, e3, () => t3) : e3, E3, i2, n2, l2, a2, !1) : (function(e4, t4, i3, n3, a3) {
              let c3 = `request is not a valid match in pattern "${t4}" for the "${n3 ? "imports" : "exports"}" resolution of ${(0, Qe.fileURLToPath)(i3)}`;
        ...
        function resolvePackageTarget(e3, t3, i2, n2, a2, c2, l2, y2, E2) {
          if (typeof t3 == "string") return resolvePackageTargetString(t3, i2, n2, e3, a2, c2, l2, y2, E2);
          if (Array.isArray(t3)) {
            let w2 = t3;
            if (w2.length === 0) return null;
            let C2, S2 = -1;
            for (; ++S2 < w2.length; ) {
              let t4 = w2[S2], I2;
              try {
                ...
                if (C2 = e4, e4.code === "ERR_INVALID_PACKAGE_TARGET") continue;
                throw e4;
              }
              if (I2 !== void 0) {
          ...
          if (typeof t3 == "object" && t3 !== null) {
            let w2 = Object.getOwnPropertyNames(t3), C2 = -1;
            for (; ++C2 < w2.length; )
            ...
            for (C2 = -1; ++C2 < w2.length; ) {
              ...
              if (S2 === "default" || E2 && E2.has(S2)) {
                let w3 = resolvePackageTarget(e3, t3[S2], i2, n2, a2, c2, l2, y2, E2);
                if (w3 === void 0) continue;
                return w3;
              }
            }
            return null;
        ...
        function packageExportsResolve(e3, t3, i2, n2, a2) {
          ...
          if ((function(e4, t4, i3) {
            ...
            let n3 = Object.getOwnPropertyNames(e4), a3 = !1, c3 = 0, l3 = -1;
            for (; ++l3 < n3.length; ) {
              let e5 = n3[l3], y3 = e5 === "" || e5[0] !== ".";
              if (c3++ === 0) a3 = y3;
            ...
            let i3 = resolvePackageTarget(e3, c2[t3], "", t3, n2, !1, !1, !1, a2);
            if (i3 == null) throw exportsNotFound(t3, e3, n2);
            return i3;
          }
          let l2 = "", y2 = "", E2 = Object.getOwnPropertyNames(c2), w2 = -1;
          for (; ++w2 < E2.length; ) {
            let i3 = E2[w2], a3 = i3.indexOf("*");
            if (a3 !== -1 && t3.startsWith(i3.slice(0, a3))) {
              t3.endsWith("/") && emitTrailingSlashPatternDeprecation(t3, e3, n2);
              let c3 = i3.slice(a3 + 1);
              t3.length >= i3.length && t3.endsWith(c3) && patternKeyCompare(l2, i3) === 1 && i3.lastIndexOf("*") === a3 && (l2 = i3, y2 = t3.slice(a3, t3.length - c3.length));
            }
          }
          if (l2) {
            let i3 = resolvePackageTarget(e3, c2[l2], y2, l2, n2, !0, !1, t3.endsWith("/"), a2);
            if (i3 == null) throw exportsNotFound(t3, e3, n2);
            return i3;
          }
        ...
        function patternKeyCompare(e3, t3) {
          let i2 = e3.indexOf("*"), n2 = t3.indexOf("*"), a2 = i2 === -1 ? e3.length : i2 + 1, c2 = n2 === -1 ? t3.length : n2 + 1;
        ...
        function packageResolve(e3, t3, i2) {
          ...
          let { packageName: n2, packageSubpath: a2, isScoped: c2 } = (function(e4, t4) {
            let i3 = e4.indexOf("/"), n3 = !0, a3 = !1;
            e4[0] === "@" && (a3 = !0, i3 === -1 || e4.length === 0 ? n3 = !1 : i3 = e4.indexOf("/", i3 + 1));
            let c3 = i3 === -1 ? e4 : e4.slice(0, i3);
            if (Lt.exec(c3) !== null && (n3 = !1), !n3) throw new Et(e4, "is not a valid package name", (0, Qe.fileURLToPath)(t4));
            return { packageName: c3, packageSubpath: "." + (i3 === -1 ? "" : e4.slice(i3)), isScoped: a3 };
          })(e3, t3), l2 = getPackageScopeConfig(t3);
          if (l2.exists) {
            let e4 = (0, Qe.pathToFileURL)(l2.pjsonPath);
            if (l2.name === n2 && l2.exports !== void 0 && l2.exports !== null) return packageExportsResolve(e4, a2, l2, t3, i2);
          }
          let y2, E2 = new URL("./node_modules/" + n2 + "/package.json", t3), w2 = (0, Qe.fileURLToPath)(E2);
          do {
            let l3 = tryStatSync(w2.slice(0, -13));
            if (!l3 || !l3.isDirectory()) {
              y2 = w2, E2 = new URL((c2 ? "../../../../node_modules/" : "../../../node_modules/") + n2 + "/package.json", E2), w2 = (0, Qe.fileURLToPath)(E2);
              continue;
            }
            let C2 = read(w2, { base: t3, specifier: e3 });
            return C2.exports !== void 0 && C2.exports !== null ? packageExportsResolve(E2, a2, C2, t3, i2) : a2 === "." ? legacyMainResolve(E2, C2, t3) : new URL(a2, E2);
          } while (w2.length !== y2.length);
        }
        function moduleResolve(e3, t3, i2, n2) {
          i2 === void 0 && (i2 = getConditionsSet());
          let a2 = t3.protocol, c2 = a2 === "data:" || a2 === "http:" || a2 === "https:", l2;
          if ((function(e4) {
          ...
          else if (a2 === "file:" && e3[0] === "#") l2 = packageImportsResolve(e3, t3, i2);
          else try {
            l2 = new URL(e3);
          } catch (n3) {
          ...
          return Ze.ok(l2 !== void 0, "expected to be defined"), l2.protocol !== "file:" ? l2 : (function(e4, t4) {
            if (Ot.exec(e4.pathname) !== null) throw new Et(e4.pathname, 'must not include encoded "/" or "\\" characters', (0, Qe.fileURLToPath)(t4));
            let i3;
            try {
            ...
            let n3 = tryStatSync(i3.endsWith("/") ? i3.slice(-1) : i3);
            if (n3 && n3.isDirectory()) {
              let n4 = new It(i3, (0, Qe.fileURLToPath)(t4));
              throw n4.url = String(e4), n4;
            }
            if (!n3 || !n3.isFile()) {
              let n4 = new wt(i3 || e4.pathname, t4 && (0, Qe.fileURLToPath)(t4), !0);
              throw n4.url = String(e4), n4;
            }
            {
              let t5 = (0, $e.realpathSync)(i3), { search: n4, hash: a3 } = e4;
        ...
        let Ut = /* @__PURE__ */ new Set(["node", "import"]), Mt = [".mjs", ".cjs", ".js", ".json"], jt = /* @__PURE__ */ new Set(["ERR_MODULE_NOT_FOUND", "ERR_UNSUPPORTED_DIR_IMPORT", "MODULE_NOT_FOUND", "ERR_PACKAGE_PATH_NOT_EXPORTED"]);
        ...
        function _resolve(e3, t3 = {}) {
          ...
          let i2 = t3.conditions ? new Set(t3.conditions) : Ut, n2 = (Array.isArray(t3.url) ? t3.url : [t3.url]).filter(Boolean).map((e4) => new URL((function(e5) {
          ...
          let a2 = [...n2];
          for (let e4 of n2) e4.protocol === "file:" && a2.push(new URL("./", e4), new URL(dist_joinURL(e4.pathname, "_index.js"), e4), new URL("node_modules", e4));
          let c2;
          for (let n3 of a2) {
            if (c2 = _tryModuleResolve(e3, n3, i2), c2) break;
            for (let a3 of ["", "/index"]) {
              for (let l2 of t3.extensions || Mt) if (c2 = _tryModuleResolve(dist_joinURL(e3, a3) + l2, n3, i2), c2) break;
              if (c2) break;
            }
            if (c2) break;
          }
          if (!c2) {
            let t4 = new Error(`Cannot find module ${e3} imported from ${a2.join(", ")}`);
        ...
        let Ft = /(?:[\s;]|^)(?:import[\s\w*,{}]*from|import\s*["'*{]|export\b\s*(?:[*{]|default|class|type|function|const|var|let|async function)|import\.meta\b)/m, Bt = /\/\*.+?\*\/|\/\/.*(?=[nr])/g;
        ...
        let $t = /* @__PURE__ */ new Set(["/", "\\", void 0]), qt = /* @__PURE__ */ Symbol.for("pathe:normalizedAlias"), Wt = /[/\\]/;
        function normalizeAliases(e3) {
          ...
          for (let e4 in t3) for (let i2 in t3) i2 === e4 || e4.startsWith(i2) || t3[e4]?.startsWith(i2) && $t.has(t3[e4][i2.length]) && (t3[e4] = t3[i2] + t3[e4].slice(i2.length));
          return Object.defineProperty(t3, qt, { value: !0, enumerable: !1 }), t3;
        }
        ...
        var Gt = { rE: "2.6.1" };
        let Kt = __require("node:crypto");
        var Ht = __webpack_require__.n(Kt);
        let zt = globalThis.process?.env || /* @__PURE__ */ Object.create(null), Jt = globalThis.process || { env: zt }, Yt = Jt !== void 0 && Jt.env && Jt.env.NODE_ENV || void 0, Qt = [["claude", ["CLAUDECODE", "CLAUDE_CODE"]], ["replit", ["REPL_ID"]], ["gemini", ["GEMINI_CLI"]], ["codex", ["CODEX_SANDBOX", "CODEX_THREAD_ID"]], ["opencode", ["OPENCODE"]], ["pi", [dist_i("PATH", /\.pi[\\/]agent/)]], ["auggie", ["AUGMENT_AGENT"]], ["goose", ["GOOSE_PROVIDER"]], ["devin", [dist_i("EDITOR", /devin/)]], ["cursor", ["CURSOR_AGENT"]], ["kiro", [dist_i("TERM_PROGRAM", /kiro/)]]];
        ...
        let Zt = (function() {
          ...
          for (let [e4, t3] of Qt) for (let i2 of t3) if (typeof i2 == "string" ? zt[i2] : i2()) return { name: e4 };
          return {};
        })(), Xt = (Zt.name, Zt.name, [["APPVEYOR"], ["AWS_AMPLIFY", "AWS_APP_ID", { ci: !0 }], ["AZURE_PIPELINES", "SYSTEM_TEAMFOUNDATIONCOLLECTIONURI"], ["AZURE_STATIC", "INPUT_AZURE_STATIC_WEB_APPS_API_TOKEN"], ["APPCIRCLE", "AC_APPCIRCLE"], ["BAMBOO", "bamboo_planKey"], ["BITBUCKET", "BITBUCKET_COMMIT"], ["BITRISE", "BITRISE_IO"], ["BUDDY", "BUDDY_WORKSPACE_ID"], ["BUILDKITE"], ["CIRCLE", "CIRCLECI"], ["CIRRUS", "CIRRUS_CI"], ["CLOUDFLARE_PAGES", "CF_PAGES", { ci: !0 }], ["CLOUDFLARE_WORKERS", "WORKERS_CI", { ci: !0 }], ["GOOGLE_CLOUDRUN", "K_SERVICE"], ["GOOGLE_CLOUDRUN_JOB", "CLOUD_RUN_JOB"], ["CODEBUILD", "CODEBUILD_BUILD_ARN"], ["CODEFRESH", "CF_BUILD_ID"], ["DRONE"], ["DRONE", "DRONE_BUILD_EVENT"], ["DSARI"], ["GITHUB_ACTIONS"], ["GITLAB", "GITLAB_CI"], ["GITLAB", "CI_MERGE_REQUEST_ID"], ["GOCD", "GO_PIPELINE_LABEL"], ["LAYERCI"], ["JENKINS", "JENKINS_URL"], ["HUDSON", "HUDSON_URL"], ["MAGNUM"], ["NETLIFY"], ["NETLIFY", "NETLIFY_LOCAL", { ci: !1 }], ["NEVERCODE"], ["RENDER"], ["SAIL", "SAILCI"], ["SEMAPHORE"], ["SCREWDRIVER"], ["SHIPPABLE"], ["SOLANO", "TDDIUM"], ["STRIDER"], ["TEAMCITY", "TEAMCITY_VERSION"], ["TRAVIS"], ["VERCEL", "NOW_BUILDER"], ["VERCEL", "VERCEL", { ci: !1 }], ["VERCEL", "VERCEL_ENV", { ci: !1 }], ["APPCENTER", "APPCENTER_BUILD_ID"], ["CODESANDBOX", "CODESANDBOX_SSE", { ci: !1 }], ["CODESANDBOX", "CODESANDBOX_HOST", { ci: !1 }], ["STACKBLITZ"], ["STORMKIT"], ["CLEAVR"], ["ZEABUR"], ["CODESPHERE", "CODESPHERE_APP_ID", { ci: !0 }], ["RAILWAY", "RAILWAY_PROJECT_ID"], ["RAILWAY", "RAILWAY_SERVICE_ID"], ["DENO-DEPLOY", "DENO_DEPLOY"], ["DENO-DEPLOY", "DENO_DEPLOYMENT_ID"], ["FIREBASE_APP_HOSTING", "FIREBASE_APP_HOSTING", { ci: !0 }], ["EDGEONE_PAGES", "EO_PAGES_CI", { ci: !0 }]]), ei = (function() {
          for (let e3 of Xt) if (zt[e3[1] || e3[0]]) return { name: e3[0].toLowerCase(), ...e3[2] };
          return zt.SHELL === "/bin/jsh" && Jt.versions?.webcontainer ? { name: "stackblitz", ci: !1 } : { name: "", ci: !1 };
        })(), ti = (ei.name, Jt.platform || ""), ii = !!zt.CI || ei.ci !== !1, si = !!Jt.stdout?.isTTY, ri = (zt.DEBUG, Yt === "test" || !!zt.TEST), ni = (Yt === "production" || zt.MODE, Yt === "dev" || Yt === "development" || zt.MODE, zt.MINIMAL, /^win/i.test(ti)), ai = (/^linux/i.test(ti), /^darwin/i.test(ti), !zt.NO_COLOR && (zt.FORCE_COLOR || (si || ni) && zt.TERM), (Jt.versions?.node || "").replace(/^v/, "") || null), oi = (Number(ai?.split(".")[0]), !!Jt?.versions?.node), ci = "Bun" in globalThis, hi = "Deno" in globalThis, li = "fastly" in globalThis, pi = [["Netlify" in globalThis, "netlify"], ["EdgeRuntime" in globalThis, "edge-light"], [globalThis.navigator?.userAgent === "Cloudflare-Workers", "workerd"], [li, "fastly"], [hi, "deno"], [ci, "bun"], [oi, "node"]];
        (function() {
          let e3 = pi.find((e4) => e4[0]);
          e3 && e3[1];
        })();
        let ui = __require("node:tty"), di = ui?.WriteStream?.prototype?.hasColors?.() ?? !1, base_format = (e3, t3) => {
          if (!di) return (e4) => e4;
          let i2 = `\x1B[${e3}m`, n2 = `\x1B[${t3}m`;
          return (e4) => {
            let a2 = e4 + "", c2 = a2.indexOf(n2);
            if (c2 === -1) return i2 + a2 + n2;
            let l2 = i2, y2 = 0, E2 = (t3 === 22 ? n2 : "") + i2;
            for (; c2 !== -1; ) l2 += a2.slice(y2, c2) + E2, y2 = c2 + n2.length, c2 = a2.indexOf(n2, y2);
        ...
        let _i = { true: mi("true"), false: gi("false"), "[rebuild]": gi("[rebuild]"), "[esm]": xi("[esm]"), "[cjs]": mi("[cjs]"), "[import]": xi("[import]"), "[require]": mi("[require]"), "[native]": vi("[native]"), "[transpile]": gi("[transpile]"), "[fallback]": fi("[fallback]"), "[unknown]": fi("[unknown]"), "[hit]": mi("[hit]"), "[miss]": gi("[miss]"), "[json]": mi("[json]"), "[data]": mi("[data]") };
        ...
        function jitiInteropDefault(e3, t3) {
          return e3.opts.interopDefault ? (function(e4) {
            ...
            let i2 = e4.default, n2 = typeof i2, a2 = i2 == null, c2 = n2 === "object" || n2 === "function";
            if (a2 && e4 instanceof Promise) return e4;
            let l2 = n2 === "function" && t4 !== "function", y2 = c2 && !(i2 instanceof Promise), E2 = /* @__PURE__ */ new Map();
            return new Proxy(e4, { get(t5, n3) {
              if (E2.has(n3)) return E2.get(n3);
              let c3;
              return n3 === "__esModule" ? c3 = !0 : n3 === "default" ? c3 = a2 ? e4 : typeof i2?.default == "function" && e4.__esModule ? i2.default : i2 : n3 in t5 ? c3 = t5[n3] : y2 && (c3 = i2[n3], typeof c3 == "function" && (c3 = c3.bind(i2))), E2.set(n3, c3), c3;
        ...
        let bi = /\.(c|m)?j(sx?)$/, ki = /\.(c|m)?t(sx?)$/;
        function jitiResolve(e3, t3, i2) {
          let n2, a2;
          if (e3.isNativeRe.test(t3)) return t3;
          if (e3.resolveTsConfigPaths && !i2.skipTsConfigPaths) {
            let n3 = e3.resolveTsConfigPaths(t3);
            for (let t4 of n3) {
              let n4 = jitiResolve(e3, t4, { ...i2, try: !0, skipTsConfigPaths: !0 });
              if (n4) return n4;
            }
          }
          e3.alias && (t3 = (function(e4, t4) {
            ...
            for (let [e5, n3] of Object.entries(t4)) {
          ...
          let l2 = (i2?.async ? [i2?.conditions, ["node", "import"], ["node", "require"]] : [i2?.conditions, ["node", "require"], ["node", "import"]]).filter(Boolean);
          for (let i3 of l2) {
            try {
          ...
          for (let a3 of e3.additionalExts)
            if (n2 = tryNativeRequireResolve(e3, t3 + a3, c2, i2) || tryNativeRequireResolve(e3, t3 + "/index" + a3, c2, i2), n2 || (ki.test(e3.filename) || ki.test(e3.parentModule?.filename || "") || bi.test(t3)) && (n2 = tryNativeRequireResolve(e3, t3.replace(bi, ".$1t$2"), c2, i2), n2)) return n2;
          if (!i2?.try) throw a2;
        }
        ...
        let wi = __require("node:fs/promises"), Ci = __require("node:perf_hooks"), Si = __require("node:vm");
        var Ii = __webpack_require__.n(Si);
        function jitiRequire(e3, t3, i2) {
          let n2 = e3.parentCache || {};
          ...
          if (Be.builtinModules.includes(t3) || t3 === ".pnp.js") return nativeImportOrRequire(e3, t3, i2.async);
          if (e3.opts.virtualModules && t3 in e3.opts.virtualModules) {
            debug(e3, "[virtual]", t3);
            let n3 = e3.opts.virtualModules[t3];
          ...
          if (e3.opts.tryNative && !e3.opts.transformOptions) try {
            ...
            if (debug(e3, "[try-native]", i2.async && e3.nativeImport ? "[import]" : "[require]", t3), i2.async && e3.nativeImport) return e3.nativeImport(t3).then((i3) => (e3.opts.moduleCache === !1 && delete e3.nativeRequire.cache[t3], jitiInteropDefault(e3, i3))).catch((n3) => (debug(e3, `[try-native] Using fallback for ${t3} because of an error:`, n3), jitiRequire({ ...e3, opts: { ...e3.opts, tryNative: !1 } }, t3, i2)));
            {
          ...
          let a2 = jitiResolve(e3, t3, i2);
          if (!a2 && i2.try) return;
          let c2 = extname(a2);
          if (c2 === ".json") {
            debug(e3, "[json]", a2);
            let t4 = e3.nativeRequire(a2);
          ...
          if (e3.opts.moduleCache) {
            let t4 = e3.nativeRequire.cache[a2];
            if (t4?.loaded) return jitiInteropDefault(e3, t4.exports);
          }
          let l2 = (0, $e.readFileSync)(a2, "utf8");
        ...
        function getCache(e3, t3, i2) {
          ...
          let n2 = ` /* v${Ti}-${utils_hash(t3.source, 16)} */
`, a2 = `${basename(pathe_M_eThtNZ_dirname(t3.filename))}-${(function(e4) {
            let t4 = e4.split(Wt).pop();
            if (!t4) return;
          ...
          let c2 = e3.opts.fsCache, l2 = pathe_M_eThtNZ_join(c2, a2);
          if (!e3.opts.rebuildFsCache && (0, $e.existsSync)(l2)) {
            let i3 = (0, $e.readFileSync)(l2, "utf8");
        ...
        function prepareCacheDir(t3) {
          if (t3.opts.fsCache === !0 && (t3.opts.fsCache = (function(t4) {
            ...
            if ((0, $e.mkdirSync)(t3.opts.fsCache, { recursive: !0 }), !(function(e3) {
              try {
                return (0, $e.accessSync)(e3, $e.constants.W_OK), !0;
              } catch {
                return !1;
              }
        ...
        function eval_evalModule(t3, i2, n2 = {}) {
          let a2 = n2.id || (n2.filename ? basename(n2.filename) : `_jitiEval.${n2.ext || (n2.async ? "mjs" : "js")}`), c2 = n2.filename || jitiResolve(t3, a2, { async: n2.async }), l2 = n2.ext || extname(c2), y2 = n2.cache || t3.parentCache || {}, E2 = /\.[cm]?tsx?$/.test(l2), w2 = l2 === ".mjs" || l2 === ".js" && (function(e3) {
            for (; e3 && e3 !== "." && e3 !== "/"; ) {
              e3 = pathe_M_eThtNZ_join(e3, "..");
              try {
                let t4 = (0, $e.readFileSync)(pathe_M_eThtNZ_join(e3, "package.json"), "utf8");
                try {
          ...
          })(c2)?.type === "module", C2 = l2 === ".cjs", S2 = n2.forceTranspile ?? (!C2 && !(w2 && n2.async) && (E2 || w2 || t3.isTransformRe.test(c2) || hasESMSyntax(i2))), I2 = Ci.performance.now();
          if (S2) {
            i2 = transform(t3, { filename: c2, source: i2, ts: E2, async: n2.async ?? !1, jsx: t3.opts.jsx });
            let e3 = Math.round(1e3 * (Ci.performance.now() - I2)) / 1e3;
            debug(t3, "[transpile]", n2.async ? "[esm]" : "[cjs]", c2, `(${e3}ms)`);
          } else {
            if (debug(t3, "[native]", n2.async ? "[import]" : "[require]", c2), n2.async) return Promise.resolve(nativeImportOrRequire(t3, c2, n2.async)).catch((e3) => (debug(t3, "Native import error:", e3), debug(t3, "[fallback]", c2), eval_evalModule(t3, i2, { ...n2, forceTranspile: !0 })));
            try {
              return nativeImportOrRequire(t3, c2, n2.async);
            } catch (e3) {
              debug(t3, "Native require error:", e3), debug(t3, "[fallback]", c2), i2 = transform(t3, { filename: c2, source: i2, ts: E2, async: n2.async ?? !1, jsx: t3.opts.jsx });
            }
          }
          let N2 = new Be.Module(c2);
          ...
          let O2 = createJiti2(c2, t3.opts, { parentModule: N2, parentCache: y2, nativeImport: t3.nativeImport, onError: t3.onError, createRequire: t3.createRequire }, !0), j2;
          ...
          let F2 = (function(e3, t4) {
            return `(${t4?.async ? "async " : ""}function (exports, require, module, __filename, __dirname, jitiImport, jitiESMResolve) { ${e3}
});`;
          })(i2, { async: n2.async });
          try {
            j2 = Ii().runInThisContext(F2, { filename: c2, lineOffset: 0, displayErrors: !1 });
          } catch (i3) {
            i3.name === "SyntaxError" && n2.async && t3.nativeImport ? (debug(t3, "[esm]", "[import]", "[fallback]", c2), j2 = (function(t4, i4, n3, a3, c3) {
              let l3 = `export default ${i4}`, y3 = c3 ? void 0 : `data:text/javascript;base64,${Buffer.from(l3).toString("base64")}`;
              return (...i5) => {
                let c4, importViaTempFile = () => (c4 = (function(t5, i6) {
                  let n4 = pathe_M_eThtNZ_join((0, e2.tmpdir)(), "jiti-esm");
                  try {
                    (0, $e.mkdirSync)(n4, { recursive: !0 });
                  } catch {
                  }
                  let a4 = pathe_M_eThtNZ_join(n4, `${basename(i6, extname(i6))}-${Date.now()}-${Math.random().toString(36).slice(2)}.mjs`);
                  return (0, $e.writeFileSync)(a4, t5), a4;
                })(l3, n3), debug(t4, "[esm]", "[tempfile]", c4), a3(pathToFileURL(c4)));
                return (y3 ? a3(y3).catch((e3) => {
                  if (e3?.code !== "ENAMETOOLONG") throw e3;
                  return importViaTempFile();
                }) : importViaTempFile()).then((e3) => e3.default(...i5)).finally(() => {
 ...
 ${`${e3}:${i3}:${n3}`}`);
        ...
        function createJiti2(e3, t3 = {}, i2, n2 = !1) {
          ...
          let c2 = a2.alias && Object.keys(a2.alias).length > 0 ? normalizeAliases(a2.alias || {}) : void 0, l2;
          if (a2.tsconfigPaths) {
            let { getTsconfig: t4, createPathsMatcher: i3 } = __webpack_require__("./node_modules/.pnpm/get-tsconfig@4.14.0/node_modules/get-tsconfig/dist/index.cjs"), n3 = t4(typeof a2.tsconfigPaths == "string" ? a2.tsconfigPaths : pathe_M_eThtNZ_dirname(e3));
            n3 && (l2 = i3(n3));
          }
          let y2 = ["typescript", "jiti", ...a2.nativeModules || []], E2 = new RegExp(`node_modules/(${y2.map((e4) => escapeStringRegexp(e4)).join("|")})/`), w2 = [...a2.transformModules || []], C2 = new RegExp(`node_modules/(${w2.map((e4) => escapeStringRegexp(e4)).join("|")})/`);
          e3 || (e3 = process.cwd()), !n2 && isDir(e3) && (e3 = pathe_M_eThtNZ_join(e3, "_index.js"));
          let S2 = pathToFileURL(e3), I2 = [...a2.extensions].filter((e4) => e4 !== ".js"), N2 = i2.createRequire(Ri ? e3.replace(/\//g, "\\") : e3), O2 = { filename: e3, url: S2, opts: a2, alias: c2, resolveTsConfigPaths: l2, nativeModules: y2, transformModules: w2, isNativeRe: E2, isTransformRe: C2, additionalExts: I2, nativeRequire: N2, onError: i2.onError, parentModule: i2.parentModule, parentCache: i2.parentCache, nativeImport: i2.nativeImport, createRequire: i2.createRequire };
          return n2 || debug(O2, "[init]", ...[["version:", Gt.rE], ["module-cache:", a2.moduleCache], ["fs-cache:", a2.fsCache], ["rebuild-fs-cache:", a2.rebuildFsCache], ["interop-defaults:", a2.interopDefault]].flat()), n2 || prepareCacheDir(O2), Object.assign(function(e4) {
            return jitiRequire(O2, e4, { async: !1 });
