...
var t, s, e, init_temporary_directory_CwHp0_NW = __esm({
  "../../../node_modules/tsx/dist/temporary-directory-CwHp0_NW.mjs"() {
    ({ geteuid: t } = process), s = t ? t() : o.userInfo().username, e = r.join(o.tmpdir(), `tsx-${s}`);
  }
});
...
var p, e2, m, i, n, init_get_pipe_path_BHW2eJdv = __esm({
  "../../../node_modules/tsx/dist/get-pipe-path-BHW2eJdv.mjs"() {
    init_temporary_directory_CwHp0_NW();
    p = Object.defineProperty, e2 = (t3, r2) => p(t3, "name", { value: r2, configurable: !0 }), m = o2(import.meta.url), i = process.platform === "win32", n = e2((t3) => {
      let r2 = a.join(e, `${t3}.pipe`);
      return i ? `\\\\?\\pipe\\${r2}` : r2;
    }, "getPipePath");
  }
});
...
function d(r2, t3) {
  ...
  let e5, o5;
  for (let c2 of Object.keys(r2)) if (c2.includes(s2)) {
    let [n2, i5, l2] = c2.split(s2);
    if (l2 === void 0 && t3.startsWith(n2) && t3.endsWith(i5)) {
      let g2 = t3.slice(n2.length, -i5.length || void 0);
      g2 && (!e5 || m2(e5, c2)) && (e5 = c2, o5 = g2);
    }
  }
  return [e5, o5];
}
var A, a2, _, E, I, R, O, w, h, f, s2, m2, p2, u, v, init_dist = __esm({
  "../../../node_modules/resolve-pkg-maps/dist/index.mjs"() {
    A = (r2) => r2 !== null && typeof r2 == "object", a2 = (r2, t3) => Object.assign(new Error(`[${r2}]: ${t3}`), { code: r2 }), _ = "ERR_INVALID_PACKAGE_CONFIG", E = "ERR_INVALID_PACKAGE_TARGET", I = "ERR_PACKAGE_PATH_NOT_EXPORTED", R = /^\d+$/, O = /^(\.{1,2}|node_modules)$/i, w = /\/|\\/, h = ((r2) => (r2.Export = "exports", r2.Import = "imports", r2))(h || {}), f = (r2, t3, e5, o5, c2) => {
      if (t3 == null) return [];
      if (typeof t3 == "string") {
        let [n2, ...i5] = t3.split(w);
...
function Ue(e5, t3 = !1) {
  let s4 = e5.length, n2 = 0, o5 = "", l2 = 0, u3 = 16, a5 = 0, r2 = 0, g2 = 0, v4 = 0, d4 = 0;
  function _4(c2, y3) {
    let A3 = 0, b3 = 0;
    for (; A3 < c2; ) {
...
function Pe(e5, t3, s4 = Q.DEFAULT) {
  let n2 = Ue(e5, !1), o5 = [], l2 = 0;
  function u3(w3) {
    return w3 ? () => l2 === 0 && w3(n2.getTokenOffset(), n2.getTokenLength(), n2.getTokenStartLine(), n2.getTokenStartCharacter()) : () => !0;
  }
  i2(u3, "toNoArgVisit");
  function a5(w3) {
    return w3 ? (j2) => l2 === 0 && w3(j2, n2.getTokenOffset(), n2.getTokenLength(), n2.getTokenStartLine(), n2.getTokenStartCharacter()) : () => !0;
  }
  i2(a5, "toOneArgVisit");
  function r2(w3) {
    return w3 ? (j2) => l2 === 0 && w3(j2, n2.getTokenOffset(), n2.getTokenLength(), n2.getTokenStartLine(), n2.getTokenStartCharacter(), () => o5.slice()) : () => !0;
  }
  i2(r2, "toOneArgVisitWithPath");
  function g2(w3) {
    return w3 ? () => {
      l2 > 0 ? l2++ : w3(n2.getTokenOffset(), n2.getTokenLength(), n2.getTokenStartLine(), n2.getTokenStartCharacter(), () => o5.slice()) === !1 && (l2 = 1);
    } : () => !0;
  }
  i2(g2, "toBeginVisit");
  function v4(w3) {
  ...
  i2(v4, "toEndVisit");
  let d4 = g2(t3.onObjectBegin), _4 = r2(t3.onObjectProperty), p5 = v4(t3.onObjectEnd), D3 = g2(t3.onArrayBegin), L2 = v4(t3.onArrayEnd), T3 = r2(t3.onLiteralValue), F3 = a5(t3.onSeparator), x = u3(t3.onComment), c2 = a5(t3.onError), y3 = s4 && s4.disallowComments, A3 = s4 && s4.allowTrailingComma;
  function b3() {
    for (; ; ) {
      let w3 = n2.scan();
  ...
  i2(k2, "handleError");
  function R4(w3) {
    let j2 = n2.getTokenValue();
    return w3 ? T3(j2) : (_4(j2), o5.push(j2)), b3(), !0;
  }
  i2(R4, "parseString");
  function W() {
    switch (n2.getToken()) {
      case 11:
        let w3 = n2.getTokenValue(), j2 = Number(w3);
  ...
  i2(W, "parseLiteral");
  function V2() {
    return n2.getToken() !== 10 ? (k2(3, [], [2, 5]), !1) : (R4(!1), n2.getToken() === 6 ? (F3(":"), b3(), U2() || k2(4, [], [2, 5])) : k2(5, [], [2, 5]), o5.pop(), !0);
  }
  i2(V2, "parseProperty");
  function M2() {
    d4(), b3();
    ...
    return p5(), n2.getToken() !== 2 ? k2(7, [2], []) : b3(), !0;
  }
  i2(M2, "parseObject");
  function z2() {
    D3(), b3();
    ...
    for (; n2.getToken() !== 4 && n2.getToken() !== 17; ) {
      ...
      w3 ? (o5.push(0), w3 = !1) : o5[o5.length - 1]++, U2() || k2(4, [], [4, 5]), j2 = !0;
    }
    return L2(), w3 || o5.pop(), n2.getToken() !== 4 ? k2(8, [4], []) : b3(), !0;
  }
  i2(z2, "parseArray");
  function U2() {
    switch (n2.getToken()) {
  ...
  return i2(U2, "parseValue"), b3(), n2.getToken() === 17 ? s4.allowEmptyContent ? !0 : (k2(4, [], []), !1) : U2() ? (n2.getToken() !== 17 && k2(9, [], []), !0) : (k2(4, [], []), !1);
}
var Le, i2, Z, E2, $e, G, fe, q, K, ae, P, Q, ce, ge, Re, ke, me, C, I2, Se, ee, ne, te, Je, se, we, de, We, Ve, be, ve, H, Me, ze, pe, Ge, Qe, Te, He, Xe, Ye, Ze, qe, X, Ae, le, _e, Ke, Oe, ye, oe, Ce, en, je, nn, ie, tn, Fe, Y, ue, De, sn, init_dist2 = __esm({
  "../../../node_modules/get-tsconfig/dist/index.mjs"() {
    init_dist();
    Le = Object.defineProperty, i2 = (e5, t3) => Le(e5, "name", { value: t3, configurable: !0 });
    i2(h2, "slash");
    Z = i2((e5) => {
      let t3 = re[e5];
      return (s4, ...n2) => {
        let o5 = `${e5}:${n2.join(":")}`, l2 = s4?.get(o5);
        return l2 === void 0 && (l2 = Reflect.apply(t3, re, n2), s4?.set(o5, l2)), l2;
      };
    }, "cacheFs"), E2 = Z("existsSync"), $e = Z("readFileSync"), G = Z("statSync"), fe = i2((e5, t3, s4) => {
      for (; ; ) {
        let n2 = m3.posix.join(e5, t3);
        if (E2(s4, n2)) return n2;
        let o5 = m3.dirname(e5);
        if (o5 === e5) return;
        e5 = o5;
      }
    }, "findUp"), q = /^\.{1,2}(\/.*)?$/, K = i2((e5) => {
      let t3 = h2(e5);
...
` + "	".repeat(t3));
    (function(e5) {
      e5.DEFAULT = { allowTrailingComma: !1 };
    })(Q || (Q = {}));
    i2(Ne, "parse$1");
    i2(Pe, "visit");
    (function(e5) {
    ...
    me = i2((e5, t3) => Re($e(t3, e5, "utf8")), "readJsonc"), C = /* @__PURE__ */ Symbol("implicitBaseUrl"), I2 = "${configDir}", Se = i2(() => {
      ...
      let o5 = `resolveFromPackageJsonPath:${e5}:${t3}:${s4}`;
      if (n2 != null && n2.has(o5)) return n2.get(o5);
      let l2 = me(e5, n2);
      if (!l2) return;
      let u3 = t3 || "tsconfig.json";
      if (!s4 && l2.exports) try {
        let [a5] = v(l2.exports, t3, ["require", "types"]);
        u3 = a5;
      } catch {
        return !1;
      }
      else !t3 && l2.tsconfig && (u3 = l2.tsconfig);
      return u3 = m3.join(e5, "..", u3), n2?.set(o5, u3), u3;
    }, "resolveFromPackageJsonPath"), ne = "package.json", te = "tsconfig.json", Je = i2((e5, t3, s4) => {
      let n2 = e5;
      ...
      let [o5, ...l2] = e5.split("/"), u3 = o5[0] === "@" ? `${o5}/${l2.shift()}` : o5, a5 = l2.join("/"), r2 = Se();
      if (r2) {
        let { resolveRequest: p5 } = r2;
        try {
          if (u3 === e5) {
            let D3 = p5(m3.join(u3, ne), t3);
            if (D3) {
              let L2 = ee(D3, a5, !1, s4);
      ...
      let g2 = fe(m3.resolve(t3), m3.join("node_modules", u3), s4);
      if (!g2 || !G(s4, g2).isDirectory()) return;
      let v4 = m3.join(g2, ne);
      if (E2(s4, v4)) {
        let p5 = ee(v4, a5, !1, s4);
        if (p5 === !1) return;
        if (p5 && E2(s4, p5) && G(s4, p5).isFile()) return p5;
      }
      let d4 = m3.join(g2, a5), _4 = d4.endsWith(".json");
      if (!_4) {
        let p5 = `${d4}.json`;
        if (E2(s4, p5)) return p5;
      }
      if (E2(s4, d4)) {
        if (G(s4, d4).isDirectory()) {
          let p5 = m3.join(d4, ne);
          if (E2(s4, p5)) {
            let L2 = ee(p5, "", !0, s4);
            if (L2 && E2(s4, L2)) return L2;
          }
          let D3 = m3.join(d4, te);
          if (E2(s4, D3)) return D3;
        } else if (_4) return d4;
      }
    }, "resolveExtendsPath"), se = i2((e5, t3) => K(m3.relative(e5, t3)), "pathRelative"), we = ["files", "include", "exclude"], de = i2((e5, t3, s4) => {
      let n2 = m3.join(t3, s4), o5 = m3.relative(e5, n2);
      return h2(o5) || "./";
    }, "resolveAndRelativize"), We = i2((e5, t3, s4) => {
      let n2 = m3.relative(e5, t3);
      if (!n2) return s4;
      let o5 = s4.startsWith("./") ? s4.slice(2) : s4;
      return h2(`${n2}/${o5}`);
    }, "prefixPattern"), Ve = i2((e5, t3, s4, n2) => {
      let o5 = Je(e5, t3, n2);
      ...
      s4.add(o5);
      let l2 = m3.dirname(o5), u3 = ve(o5, n2, s4);
      delete u3.references;
      let { compilerOptions: a5 } = u3;
      if (a5) {
        let { baseUrl: r2 } = a5;
      ...
      return u3;
    }, "resolveExtends"), be = ["outDir", "declarationDir"], ve = i2((e5, t3, s4 = /* @__PURE__ */ new Set()) => {
      let n2;
      try {
        n2 = me(e5, t3) || {};
      } catch {
      ...
      if (n2.compilerOptions) {
        let { compilerOptions: l2 } = n2;
        l2.paths && !l2.baseUrl && (l2[C] = o5);
      }
      if (n2.extends) {
        let l2 = Array.isArray(n2.extends) ? n2.extends : [n2.extends];
        delete n2.extends;
        for (let u3 of l2.reverse()) {
          let a5 = Ve(u3, o5, new Set(s4), t3), r2 = { ...a5, ...n2, compilerOptions: { ...a5.compilerOptions, ...n2.compilerOptions } };
          a5.watchOptions && (r2.watchOptions = { ...a5.watchOptions, ...n2.watchOptions }), n2 = r2;
        }
      }
      if (n2.compilerOptions) {
        let { compilerOptions: l2 } = n2, u3 = ["baseUrl", "rootDir"];
        for (let a5 of u3) {
          let r2 = l2[a5];
          if (r2 && !r2.startsWith(I2)) {
            let g2 = m3.resolve(o5, r2), v4 = se(o5, g2);
            l2[a5] = v4;
          }
        }
        for (let a5 of be) {
      ...
      if (n2.include && (n2.include = n2.include.map(h2)), n2.files && (n2.files = n2.files.map((l2) => l2.startsWith(I2) ? l2 : K(l2))), n2.watchOptions) {
        let { watchOptions: l2 } = n2;
      ...
      return n2;
    }, "_parseTsconfig"), H = i2((e5, t3) => {
      if (e5.startsWith(I2)) return h2(m3.join(t3, e5.slice(I2.length)));
    }, "interpolateConfigDir"), Me = ["outDir", "declarationDir", "outFile", "rootDir", "baseUrl", "tsBuildInfoFile"], ze = i2((e5) => {
      var t3, s4, n2, o5, l2, u3, a5, r2, g2, v4, d4, _4, p5, D3, L2, T3, F3, x, c2, y3, A3, b3, k2, R4, W, V2, M2, z2, U2, w3, j2, S2, $2;
      if (e5.strict) {
        let f5 = ["noImplicitAny", "noImplicitThis", "strictNullChecks", "strictFunctionTypes", "strictBindCallApply", "strictPropertyInitialization", "strictBuiltinIteratorReturn", "alwaysStrict", "useUnknownInCatchVariables"];
        for (let B2 of f5) e5[B2] === void 0 && (e5[B2] = !0);
      }
      if (e5.composite && ((t3 = e5.declaration) != null || (e5.declaration = !0), (s4 = e5.incremental) != null || (e5.incremental = !0)), e5.target) {
        let f5 = e5.target.toLowerCase();
        f5 === "es2015" && (f5 = "es6"), e5.target = f5, f5 === "esnext" && ((n2 = e5.module) != null || (e5.module = "es6"), (o5 = e5.useDefineForClassFields) != null || (e5.useDefineForClassFields = !0)), (f5 === "es6" || f5 === "es2016" || f5 === "es2017" || f5 === "es2018" || f5 === "es2019" || f5 === "es2020" || f5 === "es2021" || f5 === "es2022" || f5 === "es2023" || f5 === "es2024") && ((l2 = e5.module) != null || (e5.module = "es6")), (f5 === "es2022" || f5 === "es2023" || f5 === "es2024") && ((u3 = e5.useDefineForClassFields) != null || (e5.useDefineForClassFields = !0));
      }
      if (e5.module) {
        let f5 = e5.module.toLowerCase();
        if (f5 === "es2015" && (f5 = "es6"), e5.module = f5, (f5 === "es6" || f5 === "es2020" || f5 === "es2022" || f5 === "esnext" || f5 === "none" || f5 === "system" || f5 === "umd" || f5 === "amd") && ((a5 = e5.moduleResolution) != null || (e5.moduleResolution = "classic")), f5 === "system" && ((r2 = e5.allowSyntheticDefaultImports) != null || (e5.allowSyntheticDefaultImports = !0)), (f5 === "node16" || f5 === "node18" || f5 === "node20" || f5 === "nodenext" || f5 === "preserve") && ((g2 = e5.esModuleInterop) != null || (e5.esModuleInterop = !0), (v4 = e5.allowSyntheticDefaultImports) != null || (e5.allowSyntheticDefaultImports = !0)), (f5 === "node16" || f5 === "node18" || f5 === "node20" || f5 === "nodenext") && ((d4 = e5.moduleDetection) != null || (e5.moduleDetection = "force")), f5 === "node16" && ((_4 = e5.target) != null || (e5.target = "es2022"), (p5 = e5.moduleResolution) != null || (e5.moduleResolution = "node16")), f5 === "node18" && ((D3 = e5.target) != null || (e5.target = "es2022"), (L2 = e5.moduleResolution) != null || (e5.moduleResolution = "node16")), f5 === "node20" && ((T3 = e5.target) != null || (e5.target = "es2023"), (F3 = e5.moduleResolution) != null || (e5.moduleResolution = "node16"), (x = e5.resolveJsonModule) != null || (e5.resolveJsonModule = !0)), f5 === "nodenext" && ((c2 = e5.target) != null || (e5.target = "esnext"), (y3 = e5.moduleResolution) != null || (e5.moduleResolution = "nodenext"), (A3 = e5.resolveJsonModule) != null || (e5.resolveJsonModule = !0)), f5 === "node16" || f5 === "node18" || f5 === "node20" || f5 === "nodenext") {
          let B2 = e5.target;
          (B2 === "es3" || B2 === "es2022" || B2 === "es2023" || B2 === "es2024" || B2 === "esnext") && ((b3 = e5.useDefineForClassFields) != null || (e5.useDefineForClassFields = !0));
        }
      ...
      if (e5.moduleResolution) {
        ...
        f5 === "node" && (f5 = "node10"), e5.moduleResolution = f5, (f5 === "node16" || f5 === "nodenext" || f5 === "bundler") && ((R4 = e5.resolvePackageJsonExports) != null || (e5.resolvePackageJsonExports = !0), (W = e5.resolvePackageJsonImports) != null || (e5.resolvePackageJsonImports = !0)), f5 === "bundler" && ((V2 = e5.allowSyntheticDefaultImports) != null || (e5.allowSyntheticDefaultImports = !0), (M2 = e5.resolveJsonModule) != null || (e5.resolveJsonModule = !0));
      }
      e5.jsx && (e5.jsx = e5.jsx.toLowerCase()), e5.moduleDetection && (e5.moduleDetection = e5.moduleDetection.toLowerCase()), e5.importsNotUsedAsValues && (e5.importsNotUsedAsValues = e5.importsNotUsedAsValues.toLowerCase()), e5.newLine && (e5.newLine = e5.newLine.toLowerCase()), e5.esModuleInterop && ((z2 = e5.allowSyntheticDefaultImports) != null || (e5.allowSyntheticDefaultImports = !0)), e5.verbatimModuleSyntax && ((U2 = e5.isolatedModules) != null || (e5.isolatedModules = !0), (w3 = e5.preserveConstEnums) != null || (e5.preserveConstEnums = !0)), e5.isolatedModules && ((j2 = e5.preserveConstEnums) != null || (e5.preserveConstEnums = !0)), e5.rewriteRelativeImportExtensions && ((S2 = e5.allowImportingTsExtensions) != null || (e5.allowImportingTsExtensions = !0)), e5.lib && (e5.lib = e5.lib.map((f5) => f5.toLowerCase())), e5.checkJs && (($2 = e5.allowJs) != null || (e5.allowJs = !0));
    }, "normalizeCompilerOptions"), pe = i2((e5, t3 = /* @__PURE__ */ new Map()) => {
      let s4 = m3.resolve(e5), n2 = ve(s4, t3), o5 = m3.dirname(s4), { compilerOptions: l2 } = n2;
      if (l2) {
        for (let a5 of Me) {
          let r2 = l2[a5];
          if (r2) {
        ...
        for (let a5 of ["rootDirs", "typeRoots"]) {
          let r2 = l2[a5];
          r2 && (l2[a5] = r2.map((g2) => {
            let v4 = H(g2, o5);
        ...
        let { paths: u3 } = l2;
        if (u3) for (let a5 of Object.keys(u3)) u3[a5] = u3[a5].map((r2) => {
          var g2;
      ...
      return n2;
    }, "parseTsconfig"), Ge = i2((e5 = process.cwd(), t3 = "tsconfig.json", s4 = /* @__PURE__ */ new Map()) => {
      let n2 = fe(h2(e5), t3, s4);
      if (!n2) return null;
      let o5 = pe(n2, s4);
      return { path: n2, config: o5 };
    }, "getTsconfig"), Qe = /\*/g, Te = i2((e5, t3) => {
      let s4 = e5.match(Qe);
      if (s4 && s4.length > 1) throw new Error(t3);
    }, "assertStarCount"), He = i2((e5) => {
      if (e5.includes("*")) {
        let [t3, s4] = e5.split("*");
        return { prefix: t3, suffix: s4 };
      }
      return e5;
    }, "parsePattern"), Xe = i2(({ prefix: e5, suffix: t3 }, s4) => s4.startsWith(e5) && s4.endsWith(t3), "isPatternMatch"), Ye = i2((e5, t3, s4) => Object.entries(e5).map(([n2, o5]) => (Te(n2, `Pattern '${n2}' can have at most one '*' character.`), { pattern: He(n2), substitutions: o5.map((l2) => {
      ...
      let { compilerOptions: t3 } = e5.config;
      if (!t3) return null;
      let { baseUrl: s4, paths: n2 } = t3;
      if (!s4 && !n2) return null;
      let o5 = C in t3 && t3[C], l2 = m3.resolve(m3.dirname(e5.path), s4 || o5 || "."), u3 = n2 ? Ye(n2, s4, l2) : [];
      return (a5) => {
        if (q.test(a5)) return [];
        let r2 = [];
        for (let _4 of u3) {
        ...
        let g2, v4 = -1;
        for (let _4 of r2) Xe(_4.pattern, a5) && _4.pattern.prefix.length > v4 && (v4 = _4.pattern.prefix.length, g2 = _4);
        if (!g2) return s4 ? [h2(m3.join(l2, a5))] : [];
        let d4 = a5.slice(g2.pattern.prefix.length, a5.length - g2.pattern.suffix.length);
        return g2.substitutions.map((_4) => h2(_4.replace("*", d4)));
      };
    }, "createPathsMatcher"), qe = Object.defineProperty, X = i2((e5, t3) => qe(e5, "name", { value: t3, configurable: !0 }), "s"), Ae = X((e5) => {
      let t3 = "";
      for (let s4 = 0; s4 < e5.length; s4 += 1) {
        let n2 = e5[s4], o5 = n2.toUpperCase();
        t3 += n2 === o5 ? n2.toLowerCase() : o5;
      }
      return t3;
    }, "invertCase"), le = /* @__PURE__ */ new Map(), _e = X((e5, t3) => {
      let s4 = Ie.join(e5, `.is-fs-case-sensitive-test-${process.pid}`);
      try {
    ...
    }, "checkDirectoryCaseWithWrite"), Ke = X((e5, t3, s4) => {
      try {
        return _e(e5, s4);
      } catch (n2) {
    ...
    }, "checkDirectoryCaseWithFallback"), Oe = X((e5, t3 = xe, s4 = !0) => {
      let n2 = e5 ?? process.cwd();
      if (s4 && le.has(n2)) return le.get(n2);
      let o5, l2 = Ae(n2);
      return l2 !== n2 && t3.existsSync(n2) ? o5 = !t3.existsSync(l2) : o5 = Ke(n2, e5, t3), s4 && le.set(n2, o5), o5;
    }, "isFsCaseSensitive"), { join: ye } = m3.posix, oe = { ts: [".ts", ".tsx", ".d.ts"], cts: [".cts", ".d.cts"], mts: [".mts", ".d.mts"] }, Ce = i2((e5) => {
      let t3 = [...oe.ts], s4 = [...oe.cts], n2 = [...oe.mts];
      return e5 != null && e5.allowJs && (t3.push(".js", ".jsx"), s4.push(".cjs"), n2.push(".mjs")), [...t3, ...s4, ...n2];
    }, "getSupportedExtensions"), en = i2((e5) => {
      let t3 = [];
      if (!e5) return t3;
      let { outDir: s4, declarationDir: n2 } = e5;
      return s4 && t3.push(s4), n2 && t3.push(n2), t3;
    }, "getDefaultExcludeSpec"), je = i2((e5) => e5.replaceAll(/[.*+?^${}()|[\]\\]/g, String.raw`\$&`), "escapeForRegexp"), nn = ["node_modules", "bower_components", "jspm_packages"], ie = `(?!(${nn.join("|")})(/|$))`, tn = /(?:^|\/)[^.*?]+$/, Fe = "**/*", Y = "[^/]", ue = "[^./]", De = process.platform === "win32", sn = i2(({ config: e5, path: t3 }, s4 = Oe()) => {
      ...
      De && (t3 = h2(t3));
      let n2 = m3.dirname(t3), { files: o5, include: l2, exclude: u3, compilerOptions: a5 } = e5, r2 = i2((T3) => m3.isAbsolute(T3) ? T3 : ye(n2, T3), "resolvePattern"), g2 = o5?.map(r2), v4 = Ce(a5), d4 = s4 ? "" : "i", p5 = (u3 || en(a5)).map((T3) => {
        let F3 = r2(T3), x = je(F3).replaceAll(String.raw`\*\*/`, "(.+/)?").replaceAll(String.raw`\*`, `${Y}*`).replaceAll(String.raw`\?`, Y);
        return new RegExp(`^${x}($|/)`, d4);
      }), D3 = o5 || l2 ? l2 : [Fe], L2 = D3 ? D3.map((T3) => {
        let F3 = r2(T3);
        tn.test(F3) && (F3 = ye(F3, Fe));
        let x = je(F3).replaceAll(String.raw`/\*\*`, `(/${ie}${ue}${Y}*)*?`).replaceAll(/(\/)?\\\*/g, (c2, y3) => {
          let A3 = `(${ue}|(\\.(?!min\\.js$))?)*`;
      ...
      return (T3) => {
        ...
        if (De && (T3 = h2(T3)), g2 != null && g2.includes(T3) || !(!v4.some((F3) => T3.endsWith(F3)) || p5.some((F3) => F3.test(T3))) && L2 && L2.some((F3) => F3.test(T3))) return e5;
      };
    }, "createFilesMatcher");
  }
});
...
var require_main = __commonJS({
  "../../../node_modules/esbuild/lib/main.js"(exports, module2) {
    ...
    var __defProp = Object.defineProperty, __getOwnPropDesc = Object.getOwnPropertyDescriptor, __getOwnPropNames = Object.getOwnPropertyNames, __hasOwnProp = Object.prototype.hasOwnProperty, __export = (target, all) => {
      ...
      return to;
    }, __toCommonJS = (mod) => __copyProps(__defProp({}, "__esModule", { value: !0 }), mod), node_exports = {};
...
`;
    ...
    function getFlag(object, keys, key, mustBeFn) {
      ...
      if (keys[key + ""] = !0, value === void 0) return;
        ...
        if (Array.isArray(entryPoints))
          for (let i5 = 0, n2 = entryPoints.length; i5 < n2; i5++) {
            ...
            if (typeof entryPoint == "object" && entryPoint !== null) {
              ...
              if (checkForInvalidFlags(entryPoint, entryPointKeys, "in entry point at index " + i5), input === void 0) throw new Error('Missing property "in" for entry point at index ' + i5);
    ...
    function flagsForTransformOptions(callName, options, isTTY2, logLevelDefault) {
      ...
      return checkForInvalidFlags(options, keys, `in ${callName}() call`), sourcemap && flags.push(`--sourcemap=${sourcemap === !0 ? "external" : sourcemap}`), sourcefile && flags.push(`--sourcefile=${sourcefile}`), loader && flags.push(`--loader=${loader}`), banner && flags.push(`--banner=${banner}`), footer && flags.push(`--footer=${footer}`), {
        flags,
        mangleCache: validateMangleCache(mangleCache)
      };
    }
    function createChannel(streamIn) {
      let requestCallbacksByKey = {}, closeData = { didClose: !1, reason: "" }, responseCallbacks = {}, nextRequestID = 0, nextBuildKey = 0, stdout = new Uint8Array(16 * 1024), stdoutUsed = 0, readFromStdout = (chunk) => {
        ...
        closeData.didClose = !0, error && (closeData.reason = ": " + (error.message || error));
        ...
        try {
          ...
          let errors = [extractErrorMessageV8(e5, streamIn, null, void 0, "")];
          try {
          ...
          transform: ({ callName, refs, input, options, isTTY: isTTY2, fs: fs3, callback }) => {
            let details = createObjectStash(), start = (inputPath) => {
              try {
                ...
                let error = extractErrorMessageV8(e5, streamIn, details, void 0, "");
    ...
    function buildOrContextImpl(callName, buildKey, sendRequest, sendResponse, refs, streamIn, requestCallbacks, options, isTTY2, defaultWD2, callback) {
      let details = createObjectStash(), isContext = callName === "context", handleError = (e5, pluginName) => {
        let flags = [];
        try {
          pushLogFlags(flags, options, {}, isTTY2, buildLogLevelDefault);
        } catch {
        }
        let message = extractErrorMessageV8(e5, streamIn, details, void 0, pluginName);
      ...
      function buildOrContextContinue(requestPlugins, runOnEndCallbacks, scheduleOnDisposeCallbacks) {
        ...
        isContext && (requestCallbacks["on-end"] = (id, request2) => new Promise((resolve) => {
          buildResponseToResult(request2, (err, result, onEndErrors, onEndWarnings) => {
            let response = {
              errors: onEndErrors,
              warnings: onEndWarnings
            };
            provideLatestResult && provideLatestResult(err, result), latestResultPromise = void 0, provideLatestResult = void 0, sendResponse(id, response), resolve();
          });
          ...
          let didDispose = !1, result = {
            rebuild: () => (latestResultPromise || (latestResultPromise = new Promise((resolve, reject) => {
              let settlePromise;
              provideLatestResult = (err, result2) => {
                settlePromise || (settlePromise = () => err ? reject(err) : resolve(result2));
              };
            ...
            watch: (options2 = {}) => new Promise((resolve, reject) => {
              ...
              delay && (request2.delay = delay), sendRequest(refs, request2, (error2) => {
                error2 ? reject(new Error(error2)) : resolve(void 0);
              });
            }),
            ...
            dispose: () => new Promise((resolve) => {
              if (didDispose) return resolve();
              didDispose = !0, sendRequest(refs, {
                command: "dispose",
                key: buildKey
              }, () => {
                resolve(), scheduleOnDisposeCallbacks(), refs.unref();
              });
            })
          };
    ...
    var handlePlugins = async (buildKey, sendRequest, sendResponse, refs, streamIn, requestCallbacks, initialOptions, plugins, details) => {
      let onStartCallbacks = [], onEndCallbacks = [], onResolveCallbacks = {}, onLoadCallbacks = {}, onDisposeCallbacks = [], nextCallbackID = 0, i5 = 0, requestPlugins = [], isSetupDone = !1;
      plugins = [...plugins];
        ...
        try {
          ...
          let promise = setup({
            ...
            resolve: (path3, options = {}) => {
              ...
              return checkForInvalidFlags(options, keys2, "in resolve() call"), new Promise((resolve2, reject) => {
                let request = {
                  command: "resolve",
                  path: path3,
                  key: buildKey,
                ...
                pluginData != null && (request.pluginData = details.store(pluginData)), importAttributes != null && (request.with = sanitizeStringMap(importAttributes, "with")), sendRequest(refs, request, (error, response) => {
                  error !== null ? reject(new Error(error)) : resolve2({
                    errors: replaceDetailsInMessages(response.errors, details),
                    warnings: replaceDetailsInMessages(response.warnings, details),
                    path: response.path,
          ...
          return { ok: !1, error: e5, pluginName: name };
        }
      }
...
`);
          ...
          if (location)
            return note = { text: e5.message, location }, note;
        } catch {
        }
      };
    }
      ...
      if (streamIn.readFileSync && !lines[0].startsWith(at2) && lines[1].startsWith(at2))
        for (let i5 = 1; i5 < lines.length; i5++) {
          ...
          if (line.startsWith(at2))
            for (line = line.slice(at2.length); ; ) {
...
error: ${e5.text}`;
        let { file, line, column } = e5.location, pluginText = e5.pluginName ? `[plugin: ${e5.pluginName}] ` : "";
        return `
${file}:${line}:${column}: ERROR: ${pluginText}${e5.text}`;
    ...
    function pkgAndSubpathForCurrentPlatform() {
      let pkg, subpath, isWASM = !1, platformKey = `${process.platform} ${os.arch()} ${os.endianness()}`;
      if (platformKey in knownWindowsPackages)
        ...
        pkg = knownWebAssemblyFallbackPackages[platformKey], subpath = "bin/esbuild", isWASM = !0;
      else
    ...
    function generateBinPath() {
      if (isValidBinaryPath(ESBUILD_BINARY_PATH))
        if (!fs.existsSync(ESBUILD_BINARY_PATH))
          ...
          return { binPath: ESBUILD_BINARY_PATH, isWASM: !1 };
...
More information: The file containing the code for esbuild's JavaScript API (${__filename}) does not appear to be inside the esbuild package on the file system, which usually means that the esbuild package was bundled into another file. This is problematic because the API needs to run a binary executable inside the esbuild package which is located using a relative path from the API code to the executable. If the esbuild package is bundled, the relative path will be incorrect and the executable won't be found.`
    ...
    }, stop = () => (stopService && stopService(), workerThreadService && workerThreadService.stop(), Promise.resolve()), initializeWasCalled = !1, initialize = (options) => {
      ...
      stdout.on("data", readFromStdout), stdout.on("end", afterClose), stopService = () => {
        stdin.destroy(), stdout.destroy(), child.kill(), initializeWasCalled = !1, longLivedService = void 0, stopService = void 0;
      };
      let refCount = 0;
...
error: ${text}`), errors = [{ id: "", pluginName: "", text, location: null, notes: [], detail: void 0 }];
      ...
      let workerPort = worker_threads.workerData.workerPort, parentPort = worker_threads.parentPort, extractProperties = (object) => {
        let properties = {};
      ...
      try {
        ...
        defaultWD = worker_threads.workerData.defaultWD, parentPort.on("message", (msg) => {
          (async () => {
...
function Qt(s4) {
  let e5 = new Int32Array(5), n2 = [], i5 = 0;
  do {
    let o5 = Zt(s4, i5), c2 = [], u3 = !0, p5 = 0;
    e5[0] = 0;
    for (let g2 = i5; g2 < o5; g2++) {
      let b3;
      g2 = K2(s4, g2, e5, 0);
      let d4 = e5[0];
      d4 < p5 && (u3 = !1), p5 = d4, je2(s4, g2, o5) ? (g2 = K2(s4, g2, e5, 1), g2 = K2(s4, g2, e5, 2), g2 = K2(s4, g2, e5, 3), je2(s4, g2, o5) ? (g2 = K2(s4, g2, e5, 4), b3 = [d4, e5[1], e5[2], e5[3], e5[4]]) : b3 = [d4, e5[1], e5[2], e5[3]]) : b3 = [d4], c2.push(b3);
    }
...
function je2(s4, e5, n2) {
  return e5 >= n2 ? !1 : s4.charCodeAt(e5) !== Ie2;
}
function Vt(s4) {
  s4.sort(en2);
}
...
function De2(s4) {
  let e5 = new Int32Array(5), n2 = 1024 * 16, i5 = n2 - 36, o5 = new Uint8Array(n2), c2 = o5.subarray(0, i5), u3 = 0, p5 = "";
...
`), n2 = e5.filter((c2) => /^\t+/.test(c2)), i5 = e5.filter((c2) => /^ {2,}/.test(c2));
  ...
  let o5 = i5.reduce((c2, u3) => {
    let p5 = /^ +/.exec(u3)[0].length;
    return Math.min(p5, c2);
  }, 1 / 0);
  return new Array(o5 + 1).join(" ");
}
function on(s4, e5) {
  let n2 = s4.split(/[/\\]/), i5 = e5.split(/[/\\]/);
...
`), n2 = [];
  ...
  return f2(function(o5) {
    ...
    let p5 = c2 - 1, g2 = o5 - n2[p5];
    return { line: p5, column: g2 };
  }, "locate");
}
function fn(s4, e5 = "@") {
  _2 = s4, We2 = e5;
  let n2 = 2 * _2.length + (2 << 18);
  if (n2 > Z2 || !v2) {
    for (; n2 > Z2; ) Z2 *= 2;
  ...
  let o5 = [], c2 = [];
  for (; v2.ri(); ) {
    let u3 = v2.is(), p5 = v2.ie(), g2 = v2.ai(), b3 = v2.id(), d4 = v2.ss(), r2 = v2.se(), R4 = v2.it(), L2;
    v2.ip() && (L2 = ye2(b3 === -1 ? u3 : u3 + 1, _2.charCodeAt(b3 === -1 ? u3 - 1 : u3))), o5.push({ t: R4, n: L2, s: u3, e: p5, ss: d4, se: r2, d: b3, a: g2 });
  }
  for (; v2.re(); ) {
    let u3 = v2.es(), p5 = v2.ee(), g2 = v2.els(), b3 = v2.ele(), d4 = _2.charCodeAt(u3), r2 = g2 >= 0 ? _2.charCodeAt(g2) : -1;
...
function Qe2(s4, e5) {
  let n2 = e5 <= 4, i5 = s4.path.split("/"), o5 = 1, c2 = 0, u3 = !1;
...
function Ln(s4, e5) {
  if (!s4 && !e5) return "";
  let n2 = Ye2(s4), i5 = n2.type;
  if (e5 && i5 !== 7) {
    let c2 = Ye2(e5), u3 = c2.type;
    switch (i5) {
      case 1:
        n2.hash = c2.hash;
      case 2:
  ...
  Qe2(n2, i5);
  let o5 = n2.query + n2.hash;
  switch (i5) {
    case 2:
    case 3:
      return o5;
    case 4: {
      let c2 = n2.path.slice(1);
...
function An(s4) {
  for (let e5 = 1; e5 < s4.length; e5++) if (s4[e5][F] < s4[e5 - 1][F]) return !1;
  return !0;
}
function Nn(s4, e5) {
...
function Mn(s4, e5, n2, i5) {
  for (; n2 <= i5; ) {
    let o5 = n2 + (i5 - n2 >> 1), c2 = s4[o5][F] - e5;
    if (c2 === 0) return oe2 = !0, o5;
...
function jn(s4, e5, n2, i5) {
  let { lastKey: o5, lastNeedle: c2, lastIndex: u3 } = n2, p5 = 0, g2 = s4.length - 1;
  if (i5 === o5) {
...
function Dn(s4, e5, n2) {
  ...
  let o5 = i5[e5], c2 = Tn(o5, s4._decodedMemo, e5, n2);
...
function V(s4, e5) {
  ...
  let { array: i5, _indexes: o5 } = s4, c2 = i5.push(e5);
  return o5[e5] = c2 - 1;
}
function Fn(s4, e5) {
  let n2 = nt(s4, e5);
  if (n2 === void 0) return;
  let { array: i5, _indexes: o5 } = s4;
...
function Hn(s4, e5, n2) {
  let { _sources: i5, _sourcesContent: o5 } = s4, c2 = V(i5, e5);
  o5[c2] = n2;
}
function Xn(s4, e5, n2 = !0) {
  let { _sources: i5, _sourcesContent: o5, _ignoreList: c2 } = s4, u3 = V(i5, e5);
  u3 === o5.length && (o5[u3] = null), n2 ? V(c2, u3) : Fn(c2, u3);
}
function it(s4) {
  let { _mappings: e5, _sources: n2, _sourcesContent: i5, _names: o5, _ignoreList: c2 } = s4;
...
function Yn(s4, e5, n2, i5, o5, c2, u3, p5, g2) {
  let { _mappings: b3, _sources: d4, _sourcesContent: r2, _names: R4 } = e5, L2 = Qn(b3, n2), E5 = Zn(L2, i5);
  if (!o5) return er(L2, E5) ? void 0 : st(L2, E5, [i5]);
  let N3 = V(d4, o5), $2 = p5 ? V(R4, p5) : rt;
...
function Vn(s4) {
  let { length: e5 } = s4, n2 = e5;
  for (let i5 = n2 - 1; i5 >= 0 && !(s4[i5].length > 0); n2 = i5, i5--) ;
  n2 < e5 && (s4.length = n2);
}
function er(s4, e5) {
  return e5 === 0 ? !0 : s4[e5 - 1].length === 1;
}
function tr(s4, e5, n2, i5, o5, c2) {
  if (e5 === 0) return !1;
  let u3 = s4[e5 - 1];
  return u3.length === 1 ? !1 : n2 === u3[Bn] && i5 === u3[Pn] && o5 === u3[Jn] && c2 === (u3.length === 5 ? u3[Gn] : rt);
}
...
function ut(s4, e5) {
  return ct(s4, e5, "", null, !1);
}
function rr(s4, e5, n2) {
  return ct(null, nr, s4, e5, n2);
}
function ir(s4) {
  let e5 = new qn({ file: s4.map.file }), { sources: n2, map: i5 } = s4, o5 = i5.names, c2 = tt(i5);
  for (let u3 = 0; u3 < c2.length; u3++) {
    let p5 = c2[u3];
    for (let g2 = 0; g2 < p5.length; g2++) {
      let b3 = p5[g2], d4 = b3[0], r2 = ot;
      if (b3.length !== 1) {
        let G3 = n2[b3[1]];
        if (r2 = lt(G3, b3[2], b3[3], b3.length === 5 ? o5[b3[4]] : ""), r2 == null) continue;
      }
      let { column: R4, line: L2, name: E5, content: N3, source: $2, ignore: W } = r2;
      zn(e5, u3, d4, $2, L2, R4, E5), $2 && N3 != null && Hn(e5, $2, N3), W && Xn(e5, $2, !0);
    }
  }
  return e5;
}
...
function or(s4, e5) {
  let n2 = sr(s4).map((c2) => new et(c2, "")), i5 = n2.pop();
...
function ht(s4, e5, n2, i5) {
  let { resolvedSources: o5, sourcesContent: c2, ignoreList: u3 } = s4, p5 = i5 + 1, g2 = o5.map((b3, d4) => {
    let r2 = { importer: n2, depth: p5, source: b3 || "", content: void 0, ignore: void 0 }, R4 = e5(r2.source, r2), { source: L2, content: E5, ignore: N3 } = r2;
    if (R4) return ht(new et(R4, L2), e5, L2, p5);
    let $2 = E5 !== void 0 ? E5 : c2 ? c2[d4] : null, W = N3 !== void 0 ? N3 : u3 ? u3.includes(d4) : !1;
    return rr(L2, $2, W);
  });
  return ut(s4, g2);
}
function ft(s4, e5, n2) {
  let i5 = { excludeContent: !!n2, decodedMappings: !1 }, o5 = or(s4, e5);
  return new ar(ir(o5), i5);
}
var import_esbuild, Pt, f2, Ne2, Ie2, Yt, Me2, $e2, Ue2, me2, ae2, ee2, nn2, rn, an, un, ln, Q2, J2, _e2, v2, re2, ke2, Z2, Fe2, hn, _2, We2, y, Se2, Pe2, gn, Je2, bn, pn, xe2, Ge2, qe2, ze2, wn, ie2, mn, kn, yn, F, oe2, et, ve2, Wn, Bn, Pn, Jn, Gn, rt, qn, zn, ot, nr, ar, cr, ur, lr, hr, fr, dt, gt, bt, dr, gr, init_index_7AaEi15b = __esm({
  "../../../node_modules/tsx/dist/index-7AaEi15b.mjs"() {
    import_esbuild = __toESM(require_main(), 1);
    init_temporary_directory_CwHp0_NW();
    Pt = Object.defineProperty, f2 = (s4, e5) => Pt(s4, "name", { value: e5, configurable: !0 }), Ne2 = f2((s4) => Ht.createHash("sha1").update(s4).digest("hex"), "sha1"), Ie2 = 44, Yt = 59, Me2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", $e2 = new Uint8Array(64), Ue2 = new Uint8Array(128);
    for (let s4 = 0; s4 < Me2.length; s4++) {
      let e5 = Me2.charCodeAt(s4);
      $e2[s4] = e5, Ue2[e5] = s4;
    }
    me2 = typeof TextDecoder < "u" ? new TextDecoder() : typeof Buffer < "u" ? { decode(s4) {
    ...
    ae2 = class _ae {
      ...
      constructor(e5, n2, i5) {
        this.start = e5, this.end = n2, this.original = i5, this.intro = "", this.outro = "", this.content = i5, this.storeName = !1, this.edited = !1, this.previous = null, this.next = null;
      }
      appendLeft(e5) {
        this.outro += e5;
      }
      ...
      clone() {
        let e5 = new _ee(this.start, this.end, this.original);
      ...
      edit(e5, n2, i5) {
        return this.content = e5, i5 || (this.intro = "", this.outro = ""), this.storeName = n2, this.edited = !0, this;
      }
      prependLeft(e5) {
      ...
      split(e5) {
        let n2 = e5 - this.start, i5 = this.original.slice(0, n2), o5 = this.original.slice(n2);
        this.original = i5;
        let c2 = new _ee(e5, this.end, o5);
        return c2.outro = this.outro, this.outro = "", this.end = e5, this.edited ? (c2.edit("", !1), this.content = "") : this.content = i5, c2.next = this.next, c2.next && (c2.next.previous = c2), c2.previous = this, this.next = c2, c2;
      }
      toString() {
        return this.intro + this.content + this.outro;
      }
      trimEnd(e5) {
        if (this.outro = this.outro.replace(e5, ""), this.outro.length) return !0;
        let n2 = this.content.replace(e5, "");
        if (n2.length) return n2 !== this.content && (this.split(this.start + n2.length).edit("", void 0, !0), this.edited && this.edit(n2, this.storeName, !0)), !0;
        if (this.edit("", void 0, !0), this.intro = this.intro.replace(e5, ""), this.intro.length) return !0;
      }
      trimStart(e5) {
        if (this.intro = this.intro.replace(e5, ""), this.intro.length) return !0;
        let n2 = this.content.replace(e5, "");
        if (n2.length) {
          if (n2 !== this.content) {
            let i5 = this.split(this.end - n2.length);
            this.edited && i5.edit(n2, this.storeName, !0), this.edit("", void 0, !0);
          }
          return !0;
        } else if (this.edit("", void 0, !0), this.outro = this.outro.replace(e5, ""), this.outro.length) return !0;
      }
    };
    f2(tn2, "getBtoa");
    nn2 = tn2(), rn = class {
    ...
    un = /\w/, ln = class {
      ...
      addEdit(e5, n2, i5, o5) {
        if (n2.length) {
          let c2 = n2.length - 1, u3 = n2.indexOf(`
`, 0), p5 = -1;
          for (; u3 >= 0 && c2 > u3; ) {
            let b3 = [this.generatedCodeColumn, e5, i5.line, i5.column];
...
`, u3 + 1);
          ...
          let g2 = [this.generatedCodeColumn, e5, i5.line, i5.column];
      ...
      addUneditedChunk(e5, n2, i5, o5, c2) {
        let u3 = n2.start, p5 = !0, g2 = !1;
        for (; u3 < n2.end; ) {
          if (this.hires || p5 || c2.has(u3)) {
            let b3 = [this.generatedCodeColumn, e5, o5.line, o5.column];
            this.hires === "boundary" ? un.test(i5[u3]) ? g2 || (this.rawSegments.push(b3), g2 = !0) : (this.rawSegments.push(b3), g2 = !1) : this.rawSegments.push(b3);
          }
          i5[u3] === `
` ? (o5.line += 1, o5.column = 0, this.generatedCodeLine += 1, this.raw[this.generatedCodeLine] = this.rawSegments = [], this.generatedCodeColumn = 0, p5 = !0) : (o5.column += 1, this.generatedCodeColumn += 1, p5 = !1), u3 += 1;
        }
        this.pending = null;
      }
      advance(e5) {
...
`, J2 = { insertLeft: !1, insertRight: !1, storeName: !1 }, _e2 = class __e {
      static {
        f2(this, "MagicString");
      }
      constructor(e5, n2 = {}) {
        let i5 = new ee2(0, e5.length, e5);
        Object.defineProperties(this, { original: { writable: !0, value: e5 }, outro: { writable: !0, value: "" }, intro: { writable: !0, value: "" }, firstChunk: { writable: !0, value: i5 }, lastChunk: { writable: !0, value: i5 }, lastSearchedChunk: { writable: !0, value: i5 }, byStart: { writable: !0, value: {} }, byEnd: { writable: !0, value: {} }, filename: { writable: !0, value: n2.filename }, indentExclusionRanges: { writable: !0, value: n2.indentExclusionRanges }, sourcemapLocations: { writable: !0, value: new ae2() }, storedNames: { writable: !0, value: {} }, indentStr: { writable: !0, value: void 0 }, ignoreList: { writable: !0, value: n2.ignoreList } }), this.byStart[0] = i5, this.byEnd[e5.length] = i5;
      }
      ...
      clone() {
        let e5 = new __e(this.original, { filename: this.filename }), n2 = this.firstChunk, i5 = e5.firstChunk = e5.lastSearchedChunk = n2.clone();
        for (; n2; ) {
          e5.byStart[i5.start] = i5, e5.byEnd[i5.end] = i5;
          let o5 = n2.next, c2 = o5 && o5.clone();
      ...
      generateDecodedMap(e5) {
        e5 = e5 || {};
        let n2 = 0, i5 = Object.keys(this.storedNames), o5 = new ln(e5.hires), c2 = Te2(this.original);
      ...
      indent(e5, n2) {
        ...
        n2.exclude && (typeof n2.exclude[0] == "number" ? [n2.exclude] : n2.exclude).forEach((d4) => {
          for (let r2 = d4[0]; r2 < d4[1]; r2 += 1) o5[r2] = !0;
        });
        let c2 = n2.indentStart !== !1, u3 = f2((b3) => c2 ? `${e5}${b3}` : (c2 = !0, b3), "replacer");
...
`));
            ...
            if (!o5[p5]) {
              let d4 = this.original[p5];
              d4 === `
` ? c2 = !0 : d4 !== "\r" && c2 && (c2 = !1, p5 === g2.start || (this._splitChunk(g2, p5), g2 = g2.next), g2.prependRight(e5));
            }
            p5 += 1;
          }
      ...
      insertLeft(e5, n2) {
        return J2.insertLeft || (console.warn("magicString.insertLeft(...) is deprecated. Use magicString.appendLeft(...) instead"), J2.insertLeft = !0), this.appendLeft(e5, n2);
      }
      insertRight(e5, n2) {
        return J2.insertRight || (console.warn("magicString.insertRight(...) is deprecated. Use magicString.prependRight(...) instead"), J2.insertRight = !0), this.prependRight(e5, n2);
      }
      move(e5, n2, i5) {
        if (i5 >= e5 && i5 <= n2) throw new Error("Cannot move a selection inside itself");
        this._split(e5), this._split(n2), this._split(i5);
        let o5 = this.byStart[e5], c2 = this.byEnd[n2], u3 = o5.previous, p5 = c2.next, g2 = this.byStart[i5];
        if (!g2 && c2 === this.lastChunk) return this;
        let b3 = g2 ? g2.previous : this.lastChunk;
      ...
      update(e5, n2, i5, o5) {
        ...
        this._split(e5), this._split(n2), o5 === !0 && (J2.storeName || (console.warn("The final argument to magicString.overwrite(...) should be an options object. See https://github.com/rich-harris/magic-string"), J2.storeName = !0), o5 = { storeName: !0 });
        let c2 = o5 !== void 0 ? o5.storeName : !1, u3 = o5 !== void 0 ? o5.overwrite : !1;
        if (c2) {
          let b3 = this.original.slice(e5, n2);
          Object.defineProperty(this.storedNames, b3, { writable: !0, value: !0, enumerable: !0 });
        }
        let p5 = this.byStart[e5], g2 = this.byEnd[n2];
        if (p5) {
          let b3 = p5;
          for (; b3 !== g2; ) {
            if (b3.next !== this.byStart[b3.end]) throw new Error("Cannot overwrite across a split point");
            b3 = b3.next, b3.edit("", !1);
          }
          p5.edit(i5, c2, !u3);
        } else {
          let b3 = new ee2(e5, n2, "").edit(i5, c2);
      ...
      slice(e5 = 0, n2 = this.original.length) {
        ...
        for (; o5; ) {
          ...
          let u3 = o5.start < n2 && o5.end >= n2;
          if (u3 && o5.edited && o5.end !== n2) throw new Error(`Cannot use replaced character ${n2} as slice end anchor.`);
          let p5 = c2 === o5 ? e5 - o5.start : 0, g2 = u3 ? o5.content.length + n2 - o5.end : o5.content.length;
      ...
      _split(e5) {
        ...
        let n2 = this.lastSearchedChunk, i5 = e5 > n2.end;
        for (; n2; ) {
      ...
      _splitChunk(e5, n2) {
        if (e5.edited && e5.content.length) {
          let o5 = Te2(this.original)(n2);
          throw new Error(`Cannot split a chunk that has already been edited (${o5.line}:${o5.column} \u2013 "${e5.original}")`);
        }
        let i5 = e5.split(n2);
        return this.byEnd[n2] = e5, this.byStart[n2] = i5, this.byEnd[i5.end] = i5, e5 === this.lastChunk && (this.lastChunk = i5), this.lastSearchedChunk = e5, !0;
      }
      toString() {
      ...
      isEmpty() {
        ...
        do
          if (e5.intro.length && e5.intro.trim() || e5.content.length && e5.content.trim() || e5.outro.length && e5.outro.trim()) return !1;
        while (e5 = e5.next);
        return !0;
      }
      length() {
      ...
      trimEndAborted(e5) {
        let n2 = new RegExp((e5 || "\\s") + "+$");
        if (this.outro = this.outro.replace(n2, ""), this.outro.length) return !0;
        let i5 = this.lastChunk;
        do {
          let o5 = i5.end, c2 = i5.trimEnd(n2);
          if (i5.end !== o5 && (this.lastChunk === i5 && (this.lastChunk = i5.next), this.byEnd[i5.end] = i5, this.byStart[i5.next.start] = i5.next, this.byEnd[i5.next.end] = i5.next), c2) return !0;
          i5 = i5.previous;
        } while (i5);
        return !1;
      }
      ...
      trimStartAborted(e5) {
        let n2 = new RegExp("^" + (e5 || "\\s") + "+");
        if (this.intro = this.intro.replace(n2, ""), this.intro.length) return !0;
        let i5 = this.firstChunk;
        do {
          let o5 = i5.end, c2 = i5.trimStart(n2);
          if (i5.end !== o5 && (i5 === this.lastChunk && (this.lastChunk = i5.next), this.byEnd[i5.end] = i5, this.byStart[i5.next.start] = i5.next, this.byEnd[i5.next.end] = i5.next), c2) return !0;
          i5 = i5.next;
        } while (i5);
        return !1;
      }
      ...
      _replaceRegexp(e5, n2) {
        ...
        if (f2(o5, "matchAll"), e5.global) o5(e5, this.original).forEach((u3) => {
          if (u3.index != null) {
            let p5 = i5(u3, this.original);
            p5 !== u3[0] && this.overwrite(u3.index, u3.index + u3[0].length, p5);
          }
        });
        else {
          let c2 = this.original.match(e5);
          if (c2 && c2.index != null) {
            let u3 = i5(c2, this.original);
      ...
      _replaceString(e5, n2) {
        let { original: i5 } = this, o5 = i5.indexOf(e5);
      ...
      _replaceAllString(e5, n2) {
        let { original: i5 } = this, o5 = e5.length;
    ...
    }, Z2 = 2 << 19, Fe2 = new Uint8Array(new Uint16Array([1]).buffer)[0] === 1 ? function(s4, e5) {
      let n2 = s4.length, i5 = 0;
      for (; i5 < n2; ) e5[i5] = s4.charCodeAt(i5++);
    } : function(s4, e5) {
      let n2 = s4.length, i5 = 0;
      for (; i5 < n2; ) {
        let o5 = s4.charCodeAt(i5);
        e5[i5++] = (255 & o5) << 8 | o5 >>> 8;
      }
    }, hn = "xportmportlassforetaourceromsyncunctionssertvoyiedelecontininstantybreareturdebuggeawaithrwhileifcatcfinallels";
    f2(fn, "parse");
    f2(ye2, "b");
    f2(dn, "k");
    f2(Ce2, "l");
    ...
    typeof WebAssembly < "u" && (async () => {
      let { parse: s4, init: e5 } = await import("./lexer-DQCqS3nf-LQRREXVI.js");
      await e5, Se2 = s4;
    })();
    Pe2 = f2((s4, e5) => Se2 ? Se2(s4, e5) : fn(s4, e5), "parseEsm"), gn = f2((s4) => {
      if (!s4.includes("import") && !s4.includes("export")) return !1;
      try {
        return Pe2(s4)[3];
      } catch {
        return !0;
    ...
    }).toString(), pn = `.then(${bn})`, xe2 = f2((s4, e5, n2) => {
      if (n2) {
        if (!e5.includes("import(")) return;
      } else if (!e5.includes("import")) return;
      let o5 = Pe2(e5, s4)[0].filter((g2) => g2.d > -1);
      if (o5.length === 0) return;
      let c2 = new _e2(e5);
      for (let g2 of o5) c2.appendRight(g2.se, pn);
      let u3 = c2.toString(), p5 = c2.generateMap({ source: s4, includeContent: !1, hires: "boundary" });
      return { code: u3, map: p5 };
    }, "transformDynamicImport"), Ge2 = f2((s4) => {
      try {
        let e5 = U.readFileSync(s4, "utf8");
        return JSON.parse(e5);
      } catch {
      }
    }, "readJsonFile"), qe2 = f2(() => {
    }, "noop"), ze2 = f2(() => Math.floor(Date.now() / 1e8), "getTime"), wn = class extends Map {
      static {
        f2(this, "FileCache");
      }
      cacheDirectory = e;
      ...
      cacheFiles;
      constructor() {
        super(), U.mkdirSync(this.cacheDirectory, { recursive: !0 }), this.cacheFiles = U.readdirSync(this.cacheDirectory).map((e5) => {
          let [n2, i5] = e5.split("-");
      ...
      get(e5) {
        let n2 = super.get(e5);
        if (n2) return n2;
        let i5 = this.cacheFiles.find((u3) => u3.key === e5);
        if (!i5) return;
        let o5 = X2.join(this.cacheDirectory, i5.fileName), c2 = Ge2(o5);
        if (!c2) {
          U.promises.unlink(o5).then(() => {
            let u3 = this.cacheFiles.indexOf(i5);
      ...
      expireDiskCache() {
        let e5 = ze2();
        for (let n2 of this.cacheFiles) e5 - n2.time > 7 && U.promises.unlink(X2.join(this.cacheDirectory, n2.fileName)).catch(qe2);
      }
      async removeOldCacheDirectory() {
        try {
          await U.promises.access(this.oldCacheDirectory).then(() => !0) && ("rm" in U.promises ? await U.promises.rm(this.oldCacheDirectory, { recursive: !0, force: !0 }) : await U.promises.rmdir(this.oldCacheDirectory, { recursive: !0 }));
        } catch {
        }
      }
    }, ie2 = process.env.TSX_DISABLE_CACHE ? /* @__PURE__ */ new Map() : new wn(), mn = /^[\w+.-]+:\/\//, kn = /^([\w+.-]+:)\/\/([^@/#?]*@)?([^:/#?]*)(:\d+)?(\/[^#?]*)?(\?[^#]*)?(#.*)?/, yn = /^file:(?:\/\/((?![a-z]:)[^/#?]*)?)?(\/?[^#?]*)(\?[^#]*)?(#.*)?/i;
    f2(Cn, "isAbsoluteUrl");
    ...
    et = class {
      ...
      constructor(e5, n2) {
        let i5 = typeof e5 == "string";
        if (!i5 && e5._decodedMemo) return e5;
        let o5 = i5 ? JSON.parse(e5) : e5, { version: c2, file: u3, names: p5, sourceRoot: g2, sources: b3, sourcesContent: d4 } = o5;
    ...
    f2(V, "put");
    f2(Fn, "remove");
    Wn = 0, Bn = 1, Pn = 2, Jn = 3, Gn = 4, rt = -1, qn = class {
      static {
        f2(this, "GenMapping");
      }
    ...
    f2(Er, "cast");
    zn = f2((s4, e5, n2, i5, o5, c2, u3, p5) => Yn(!0, s4, e5, n2, i5, o5, c2, u3), "maybeAddSegment");
    ...
    ar = class {
      ...
      constructor(e5, n2) {
        let i5 = n2.decodedMappings ? it(e5) : Kn(e5);
    ...
    cr = f2((s4, e5, n2) => {
      let i5 = [], o5 = { code: e5 };
      for (let c2 of n2) {
        let u3 = c2(s4, o5.code);
        u3 && (Object.assign(o5, u3), i5.unshift(u3.map));
      }
      return { ...o5, map: ft(i5, () => null) };
    }, "applyTransformersSync"), ur = f2(async (s4, e5, n2) => {
      let i5 = [], o5 = { code: e5 };
      for (let c2 of n2) {
        let u3 = await c2(s4, o5.code);
        u3 && (Object.assign(o5, u3), i5.unshift(u3.map));
      }
      return { ...o5, map: ft(i5, () => null) };
    }, "applyTransformers"), lr = Object.freeze({ target: `node${process.versions.node}`, loader: "default" }), hr = /^--inspect(?:-brk|-port|-publish-uid|-wait)?(?:=|$)/, fr = process.execArgv.some((s4) => hr.test(s4)), dt = { ...lr, sourcemap: !0, sourcesContent: !!process.env.NODE_V8_COVERAGE || fr, minifyWhitespace: !0, keepNames: !0 }, gt = f2((s4) => {
      let e5 = s4.sourcefile;
      if (e5) {
        let n2 = X2.extname(e5.split("?")[0]);
      ...
      let p5 = { ...dt, format: "cjs", sourcefile: c2, define: i5, banner: `__filename=${JSON.stringify(c2)};(()=>{`, footer: "})()", platform: "node", ...n2 }, g2 = Ne2([s4, JSON.stringify(p5), import_esbuild.version, Je2].join("-")), b3 = ie2.get(g2);
      return b3 || (b3 = cr(e5, s4, [(d4, r2) => {
        ...
        return R4(L2);
      }, (d4, r2) => xe2(d4, r2, !0)]), ie2.set(g2, b3)), b3;
    }, "transformSync"), gr = f2(async (s4, e5, n2) => {
      let i5 = { ...dt, format: "esm", sourcefile: e5, ...n2 }, o5 = Ne2([s4, JSON.stringify(i5), import_esbuild.version, Je2].join("-")), c2 = ie2.get(o5);
      return c2 || (c2 = await ur(e5, s4, [async (u3, p5) => {
        ...
        return g2(b3);
      }, (u3, p5) => xe2(u3, p5, !0)]), ie2.set(o5, c2)), c2;
    }, "transform");
  }
});
...
var a3, o3, m4, c, f3, init_client_BQVF1NaW = __esm({
  "../../../node_modules/tsx/dist/client-BQVF1NaW.mjs"() {
    init_get_pipe_path_BHW2eJdv();
    a3 = Object.defineProperty, o3 = (e5, n2) => a3(e5, "name", { value: n2, configurable: !0 }), m4 = o3(() => new Promise((e5) => {
      let n2 = n(process.ppid), t3 = p3.createConnection(n2, () => {
        e5(o3((i5) => {
          let r2 = Buffer.from(JSON.stringify(i5)), s4 = Buffer.alloc(4);
    ...
    }), "connectToServer"), c = { send: void 0 }, f3 = m4();
    f3.then((e5) => {
      c.send = e5;
    }, () => {
    });
...
function e3(s4, n2, r2 = 1) {
  let o5 = `\x1B[${s4}m`, c2 = `\x1B[${n2}m`, a5 = new RegExp(`\\x1b\\[${n2}m`, "g");
  return (p5) => f4.enabled && f4.supportLevel >= r2 ? o5 + ("" + p5).replace(a5, o5) + c2 : "" + p5;
}
var u2, g, t2, l, i3, f4, b, d2, O3, C2, R2, I3, L, E3, T, init_index_gbaejti9 = __esm({
  "../../../node_modules/tsx/dist/index-gbaejti9.mjs"() {
    u2 = Object.defineProperty, g = (s4, n2) => u2(s4, "name", { value: n2, configurable: !0 }), t2 = !0, l = typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {}, i3 = 0;
    if (l.process && l.process.env && l.process.stdout) {
      let { FORCE_COLOR: s4, NODE_DISABLE_COLORS: n2, NO_COLOR: r2, TERM: o5, COLORTERM: c2 } = l.process.env;
      n2 || r2 || s4 === "0" ? t2 = !1 : s4 === "1" || s4 === "2" || s4 === "3" ? t2 = !0 : o5 === "dumb" ? t2 = !1 : "CI" in l.process.env && ["TRAVIS", "CIRCLECI", "APPVEYOR", "GITLAB_CI", "GITHUB_ACTIONS", "BUILDKITE", "DRONE"].some((a5) => a5 in l.process.env) ? t2 = !0 : t2 = process.stdout.isTTY, t2 && (process.platform === "win32" || c2 && (c2 === "truecolor" || c2 === "24bit") ? i3 = 3 : o5 && (o5.endsWith("-256color") || o5.endsWith("256")) ? i3 = 2 : i3 = 1);
    }
    f4 = { enabled: t2, supportLevel: i3 };
    g(e3, "kolorist");
    b = e3(30, 39), d2 = e3(33, 39), O3 = e3(90, 39), C2 = e3(92, 39), R2 = e3(95, 39), I3 = e3(96, 39), L = e3(44, 49), E3 = e3(100, 49), T = e3(103, 49);
  }
});
...
var K3, o4, R3, D2, me3, N2, j, pe2, y2, C3, E4, Q3, M, _3, S, A2, T2, Pe3, I4, F2, v3, J3, P2, je3, be2, xe3, k, $, ye3, Ee, B, G2, _e3, Se3, b2, X3, w2, ve3, z, we2, Me3, Te3, Fe3, H2, $e3, init_register_CFH5oNdT = __esm({
  "../../../node_modules/tsx/dist/register-CFH5oNdT.mjs"() {
    init_get_pipe_path_BHW2eJdv();
    init_dist2();
    init_index_7AaEi15b();
    ...
    init_index_gbaejti9();
    K3 = Object.defineProperty, o4 = (s4, e5) => K3(s4, "name", { value: e5, configurable: !0 }), R3 = o4((s4) => {
      if (!s4.startsWith("data:text/javascript,")) return;
      let e5 = s4.indexOf("?");
      if (e5 === -1) return;
      let n2 = new URLSearchParams(s4.slice(e5 + 1)).get("filePath");
      if (n2) return n2;
    }, "getOriginalFilePath"), D2 = o4((s4) => {
      let e5 = R3(s4);
      return e5 && (d3._cache[e5] = d3._cache[s4], delete d3._cache[s4], s4 = e5), s4;
    }, "interopCjsExports"), me3 = o4((s4) => {
      let e5 = s4.indexOf(":");
      if (e5 !== -1) return s4.slice(0, e5);
    }, "getScheme"), N2 = o4((s4) => s4[0] === "." && (s4[1] === "/" || s4[1] === "." || s4[2] === "/"), "isRelativePath"), j = o4((s4) => N2(s4) || p4.isAbsolute(s4), "isFilePath"), pe2 = o4((s4) => {
      if (j(s4)) return !0;
      let e5 = me3(s4);
      return e5 && e5 !== "node";
    }, "requestAcceptsQuery"), y2 = "file://", C3 = /\.([cm]?ts|[tj]sx)($|\?)/, E4 = /\/(?:$|\?)/, Q3 = `${p4.sep}node_modules${p4.sep}`, S = !1, A2 = o4((s4) => {
      let e5 = null;
      if (s4) {
        let a5 = p4.resolve(s4);
      ...
      M = sn(e5), _3 = Ze(e5), S = e5?.config.compilerOptions?.allowJs ?? !1;
    }, "loadTsconfig"), T2 = o4((s4) => Array.from(s4).length > 0 ? `?${s4.toString()}` : "", "urlSearchParamsStringify"), Pe3 = `
//# sourceMappingURL=data:application/json;base64,`, I4 = o4(() => process.sourceMapsEnabled ?? !0, "shouldApplySourceMap"), F2 = o4(({ code: s4, map: e5 }) => s4 + Pe3 + Buffer.from(JSON.stringify(e5), "utf8").toString("base64"), "inlineSourceMap"), v3 = Number(process.env.TSX_DEBUG);
    v3 && (f4.enabled = !0, f4.supportLevel = 3);
    J3 = o4((s4) => (e5, ...a5) => {
      if (!v3 || e5 > v3) return;
      let n2 = `${E3(` tsx P${process.pid} `)} ${s4}`, t3 = a5.map((r2) => typeof r2 == "string" ? r2 : oe3(r2, { colors: !0 })).join(" ");
      te2(1, `${n2} ${t3}
`);
    }, "createLog"), P2 = J3(T(b(" CJS "))), je3 = J3(L(" ESM ")), be2 = [".cts", ".mts", ".ts", ".tsx", ".jsx"], xe3 = [".js", ".cjs", ".mjs"], k = [".ts", ".tsx", ".jsx"], $ = o4((s4, e5, a5, n2) => {
      let t3 = Object.getOwnPropertyDescriptor(s4, e5);
      t3?.set ? s4[e5] = a5 : (!t3 || t3.configurable) && Object.defineProperty(s4, e5, { value: a5, enumerable: t3?.enumerable || n2?.enumerable, writable: n2?.writable ?? (t3 ? t3.writable : !0), configurable: n2?.configurable ?? (t3 ? t3.configurable : !0) });
    }, "safeSet"), ye3 = o4((s4, e5, a5) => {
      let n2 = e5[".js"], t3 = o4((r2, c2) => {
        if (s4.enabled === !1) return n2(r2, c2);
        let [i5, f5] = c2.split("?");
        ...
        let u3 = be2.some((m6) => i5.endsWith(m6)), g2 = xe3.some((m6) => i5.endsWith(m6));
        ...
        if (i5.endsWith(".cjs")) {
          ...
          let m6 = dr(h3, c2, { tsconfigRaw: M?.(i5) });
          h3 = I4() ? F2(m6) : m6.code;
        }
        P2(1, "loaded", { filePath: i5 }), r2._compile(h3, i5);
      }, "transformer");
      $(e5, ".js", t3);
      for (let r2 of k) $(e5, r2, t3, { enumerable: !a5, writable: !0, configurable: !0 });
      return $(e5, ".mjs", t3, { writable: !0, configurable: !0 }), () => {
        e5[".js"] === t3 && (e5[".js"] = n2);
        for (let r2 of [...k, ".mjs"]) e5[r2] === t3 && delete e5[r2];
      };
    }, "createExtensions"), Ee = o4((s4) => (e5) => {
    ...
    }, "createImplicitResolver"), B = [".js", ".json"], G2 = [".ts", ".tsx", ".jsx"], _e3 = [...G2, ...B], Se3 = [...B, ...G2], b2 = /* @__PURE__ */ Object.create(null);
    b2[".js"] = [".ts", ".tsx", ".js", ".jsx"], b2[".jsx"] = [".tsx", ".ts", ".jsx", ".js"], b2[".cjs"] = [".cts"], b2[".mjs"] = [".mts"];
    X3 = o4((s4) => {
      let e5 = s4.split("?"), a5 = e5[1] ? `?${e5[1]}` : "", [n2] = e5, t3 = p4.extname(n2), r2 = [], c2 = b2[t3];
      if (c2) {
        let f5 = n2.slice(0, -t3.length);
        r2.push(...c2.map((l2) => f5 + l2 + a5));
      }
      let i5 = !(s4.startsWith(y2) || j(n2)) || n2.includes(Q3) || n2.includes("/node_modules/") ? Se3 : _e3;
      return r2.push(...i5.map((f5) => n2 + f5 + a5)), r2;
    }, "mapTsExtensions"), w2 = o4((s4, e5, a5) => {
      if (P2(3, "resolveTsFilename", { request: e5, isDirectory: E4.test(e5), isTsParent: a5, allowJs: S }), E4.test(e5) || !a5 && !S) return;
      let n2 = X3(e5);
      if (n2) for (let t3 of n2) try {
        return s4(t3);
      } catch (r2) {
        let { code: c2 } = r2;
        if (c2 !== "MODULE_NOT_FOUND" && c2 !== "ERR_PACKAGE_PATH_NOT_EXPORTED") throw r2;
      }
    }, "resolveTsFilename"), ve3 = o4((s4, e5) => (a5) => {
      ...
      try {
        ...
        if (t3.code === "MODULE_NOT_FOUND") {
          if (t3.path) {
            let c2 = t3.message.match(/^Cannot find module '([^']+)'$/);
            if (c2) {
              let f5 = c2[1], l2 = w2(s4, f5, e5);
              if (l2) return l2;
            }
            let i5 = t3.message.match(/^Cannot find module '([^']+)'. Please verify that the package.json has a valid "main" entry$/);
            if (i5) {
              let f5 = i5[1], l2 = w2(s4, f5, e5);
              if (l2) return l2;
            }
          }
          let r2 = w2(s4, a5, e5);
    ...
    }, "createTsExtensionResolver"), z = "at cjsPreparseModuleExports (node:internal", we2 = o4((s4) => {
      let e5 = s4.stack.split(`
`).slice(1);
      return e5[1].includes(z) || e5[2].includes(z);
    }, "isFromCjsLexer"), Me3 = o4((s4, e5) => {
      let a5 = s4.split("?"), n2 = new URLSearchParams(a5[1]);
      if (e5?.filename) {
        let t3 = R3(e5.filename), r2;
        if (t3) {
          let f5 = t3.split("?"), l2 = f5[0];
        ...
        let i5 = new URLSearchParams(r2).get("namespace");
      ...
      return a5(s4);
    }, "resolveTsPaths"), Fe3 = o4((s4, e5, a5) => (n2, t3, ...r2) => {
      if (s4.enabled === !1) return e5(n2, t3, ...r2);
      n2 = D2(n2);
      let [c2, i5, f5] = Me3(n2, t3);
    ...
    }, "resolveContext"), $e3 = o4((s4) => {
      let { sourceMapsEnabled: e5 } = process, a5 = { enabled: !0 };
      A2(process.env.TSX_TSCONFIG_PATH), process.setSourceMapsEnabled(!0);
      let n2 = d3._resolveFilename, t3 = Fe3(a5, n2, s4?.namespace);
      d3._resolveFilename = t3;
      let r2 = ye3(a5, d3._extensions, s4?.namespace), c2 = o4(() => {
        e5 === !1 && process.setSourceMapsEnabled(!1), a5.enabled = !1, d3._resolveFilename === t3 && (d3._resolveFilename = n2), r2();
      }, "unregister");
      if (s4?.namespace) {
        let i5 = o4((l2, u3) => {
          let g2 = H2(l2, u3), [h3, m6] = g2.split("?"), x = new URLSearchParams(m6);
          return s4.namespace && !h3.startsWith("node:") && x.set("namespace", s4.namespace), m(h3 + T2(x));
        }, "scopedRequire");
        c2.require = i5;
        let f5 = o4((l2, u3, g2) => {
          let h3 = H2(l2, u3), [m6, x] = h3.split("?"), L2 = new URLSearchParams(x);
          return s4.namespace && !m6.startsWith("node:") && L2.set("namespace", s4.namespace), t3(m6 + T2(L2), module, !1, g2);
        }, "scopedResolve");
...
var m5, a4, e4, s3, i4, init_require_DQxpCAr4 = __esm({
  "../../../node_modules/tsx/dist/require-DQxpCAr4.mjs"() {
    init_get_pipe_path_BHW2eJdv();
    init_register_CFH5oNdT();
    m5 = Object.defineProperty, a4 = (r2, t3) => m5(r2, "name", { value: t3, configurable: !0 }), s3 = a4((r2, t3) => (e4 || (e4 = $e3({ namespace: Date.now().toString() })), e4.require(r2, t3)), "tsxRequire"), i4 = a4((r2, t3, c2) => (e4 || (e4 = $e3({ namespace: Date.now().toString() })), e4.resolve(r2, t3, c2)), "resolve");
...
var import_esbuild2, init_api = __esm({
  "../../../node_modules/tsx/dist/cjs/api/index.mjs"() {
    init_get_pipe_path_BHW2eJdv();
    init_register_CFH5oNdT();
    init_require_DQxpCAr4();
    init_temporary_directory_CwHp0_NW();
    init_dist2();
    init_index_7AaEi15b();
